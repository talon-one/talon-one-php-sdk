...
------------ | ------------- | ------------- | -------------
**customerProfile** | [**\TalonOne\Client\Model\CustomerProfile**](CustomerProfile.md) | The customer profile associated with the event. | [optional]
**loyalty** | [**\TalonOne\Client\Model\Loyalty**](Loyalty.md) | The loyalty program status of the customer. | [optional]
...
**rewards** | [**\TalonOne\Client\Model\RewardWithUnlocks[]**](RewardWithUnlocks.md) | The unlocked rewards for the customer profile. | [optional]
...
**customerSession** | [**\TalonOne\Client\Model\CustomerSessionV2**](CustomerSessionV2.md) | The session that was processed. | [optional]
**return** | [**\TalonOne\Client\Model\ModelReturn**](ModelReturn.md) | The return that was processed. | [optional]
