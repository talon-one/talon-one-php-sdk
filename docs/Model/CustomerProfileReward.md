...
**rule** | [**\TalonOne\Client\Model\RuleMetadata**](RuleMetadata.md) | Customer-facing rule metadata for the reward. Only returned when the reward defines a rule. | [optional]
