...
**supportRequestId** | **int** | ID of the support request to approve. When provided by an admin, the points are added on behalf of the support user who created the request. | [optional]
