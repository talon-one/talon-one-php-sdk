...
------------ | ------------- | ------------- | -------------
**transactionUUIDs** | **string[]** | An array of transaction UUIDs used to activate specific pending point transactions.   If provided, do not include the &#x60;sessionId&#x60; parameter. | [optional]
