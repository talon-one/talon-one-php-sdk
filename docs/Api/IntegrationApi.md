...
```php
bestPriorPrice($bestPriorPriceRequest): \TalonOne\Client\Model\BestPriorPrice[]
```
...
$bestPriorPriceRequest = new \TalonOne\Client\Model\BestPriorPriceRequest(); // \TalonOne\Client\Model\BestPriorPriceRequest | body

try {
    $result = $apiInstance->bestPriorPrice($bestPriorPriceRequest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling IntegrationApi->bestPriorPrice: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **bestPriorPriceRequest** | [**\TalonOne\Client\Model\BestPriorPriceRequest**](../Model/BestPriorPriceRequest.md)| body | |

### Return type

[**\TalonOne\Client\Model\BestPriorPrice[]**](../Model/BestPriorPrice.md)
...
```php
createAudienceV2($newAudience): \TalonOne\Client\Model\Audience
```
...
$newAudience = {"name":"VIP Customers","description":"Customers with high lifetime value and frequent purchases","sandbox":false,"createdIn3rdParty":false}; // \TalonOne\Client\Model\NewAudience | body

try {
    $result = $apiInstance->createAudienceV2($newAudience);
    print_r($result);
} catch (Exception $e) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **newAudience** | [**\TalonOne\Client\Model\NewAudience**](../Model/NewAudience.md)| body | |
...
$couponReservations = new \TalonOne\Client\Model\CouponReservations(); // \TalonOne\Client\Model\CouponReservations | body
...
| **couponReservations** | [**\TalonOne\Client\Model\CouponReservations**](../Model/CouponReservations.md)| body | |
...
```php
createReferral($newReferral): \TalonOne\Client\Model\Referral
```
...
$newReferral = new \TalonOne\Client\Model\NewReferral(); // \TalonOne\Client\Model\NewReferral | body
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **newReferral** | [**\TalonOne\Client\Model\NewReferral**](../Model/NewReferral.md)| body | |
...
```php
createReferralsForMultipleAdvocates($newReferralsForMultipleAdvocates, $silent): \TalonOne\Client\Model\CreateReferralsForMultipleAdvocates201Response
```
...
$newReferralsForMultipleAdvocates = new \TalonOne\Client\Model\NewReferralsForMultipleAdvocates(); // \TalonOne\Client\Model\NewReferralsForMultipleAdvocates | body
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **newReferralsForMultipleAdvocates** | [**\TalonOne\Client\Model\NewReferralsForMultipleAdvocates**](../Model/NewReferralsForMultipleAdvocates.md)| body | |
...
[**\TalonOne\Client\Model\CreateReferralsForMultipleAdvocates201Response**](../Model/CreateReferralsForMultipleAdvocates201Response.md)
...
```php
generateLoyaltyCard($loyaltyProgramId, $generateLoyaltyCard): \TalonOne\Client\Model\LoyaltyCard
```
...
$generateLoyaltyCard = new \TalonOne\Client\Model\GenerateLoyaltyCard(); // \TalonOne\Client\Model\GenerateLoyaltyCard | body

try {
    $result = $apiInstance->generateLoyaltyCard($loyaltyProgramId, $generateLoyaltyCard);
    print_r($result);
} catch (Exception $e) {
...
| **generateLoyaltyCard** | [**\TalonOne\Client\Model\GenerateLoyaltyCard**](../Model/GenerateLoyaltyCard.md)| body | |
...
```php
getCustomerAchievementHistory($integrationId, $achievementId, $progressStatus, $startDate, $endDate, $pageSize, $skip): \TalonOne\Client\Model\GetCustomerAchievementHistory200Response
```
...
[**\TalonOne\Client\Model\GetCustomerAchievementHistory200Response**](../Model/GetCustomerAchievementHistory200Response.md)
...
```php
getCustomerAchievements($integrationId, $campaignIds, $achievementIds, $achievementStatus, $currentProgressStatus, $pageSize, $skip): \TalonOne\Client\Model\GetCustomerAchievements200Response
```
...
[**\TalonOne\Client\Model\GetCustomerAchievements200Response**](../Model/GetCustomerAchievements200Response.md)
...
```php
getCustomerSession($customerSessionId): \TalonOne\Client\Model\IntegrationCustomerSessionResponse
```
...
```php
getEventV3($integrationId): \TalonOne\Client\Model\EventV3
```
...
```php
getLoyaltyBalances($loyaltyProgramId, $integrationId, $endDate, $subledgerId, $includeTiers, $includeProjectedTier): \TalonOne\Client\Model\LoyaltyBalancesWithTiers
```
...
```php
getLoyaltyCardBalances($loyaltyProgramId, $loyaltyCardId, $endDate, $subledgerId): \TalonOne\Client\Model\LoyaltyCardBalances
```
...
```php
getLoyaltyCardPoints($loyaltyProgramId, $loyaltyCardId, $status, $subledgerId, $customerSessionIDs, $transactionUUIDs, $pageSize, $skip, $sort): \TalonOne\Client\Model\GetLoyaltyCardPoints200Response
```
...
try {
    $result = $apiInstance->getLoyaltyCardPoints($loyaltyProgramId, $loyaltyCardId, $status, $subledgerId, $customerSessionIDs, $transactionUUIDs, $pageSize, $skip, $sort);
    print_r($result);
} catch (Exception $e) {
...
[**\TalonOne\Client\Model\GetLoyaltyCardPoints200Response**](../Model/GetLoyaltyCardPoints200Response.md)
...
[**\TalonOne\Client\Model\GetLoyaltyCardTransactions200Response**](../Model/GetLoyaltyCardTransactions200Response.md)
...
```php
getLoyaltyProgramProfilePoints($loyaltyProgramId, $integrationId, $status, $subledgerId, $customerSessionIDs, $transactionUUIDs, $pageSize, $skip, $sort): \TalonOne\Client\Model\GetLoyaltyProgramProfilePoints200Response
```
...
[**\TalonOne\Client\Model\GetLoyaltyProgramProfilePoints200Response**](../Model/GetLoyaltyProgramProfilePoints200Response.md)
...
```php
getReservedCustomers($couponValue): \TalonOne\Client\Model\GetReservedCustomers200Response
```
...
[**\TalonOne\Client\Model\GetReservedCustomers200Response**](../Model/GetReservedCustomers200Response.md)
...
```php
integrationGetAllCampaigns($pageSize, $skip, $campaignIds, $startAfter, $startBefore, $endAfter, $endBefore, $storeId, $audienceId): \TalonOne\Client\Model\IntegrationGetAllCampaigns200Response
```
...
```php
linkLoyaltyCardToProfile($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration): \TalonOne\Client\Model\LoyaltyCard
```
...
try {
    $result = $apiInstance->linkLoyaltyCardToProfile($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration);
    print_r($result);
} catch (Exception $e) {
...
```php
syncCatalog($catalogId, $catalogSyncRequest): \TalonOne\Client\Model\Catalog
```
...
$catalogSyncRequest = {"actions":[{"type":"ADD","payload":{"sku":"SKU1241028","attributes":{"color":"Navy blue","type":"shoes"},"replaceIfExists":true,"price":100,"product":{"name":"sneakers"}}}]}; // \TalonOne\Client\Model\CatalogSyncRequest | body

try {
    $result = $apiInstance->syncCatalog($catalogId, $catalogSyncRequest);
    print_r($result);
} catch (Exception $e) {
...
| **catalogSyncRequest** | [**\TalonOne\Client\Model\CatalogSyncRequest**](../Model/CatalogSyncRequest.md)| body | |
...
$integrationEventV2Request = {profileId=customer-123, type=newsletter_signup, attributes={SubscriptionType=weekly}, responseContent=[customerProfile, triggeredCampaigns]}; // \TalonOne\Client\Model\IntegrationEventV2Request | body
$silent = 'yes'; // string | Possible values: `yes` or `no`. - `yes`: Increases the performance of the API call by returning a 204 response. - `no`: Returns a 200 response that contains the updated customer profiles.
$dry = True; // bool | Indicates whether to persist the changes. Changes are ignored when `dry=true`.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **integrationEventV2Request** | [**\TalonOne\Client\Model\IntegrationEventV2Request**](../Model/IntegrationEventV2Request.md)| body | |
| **silent** | **string**| Possible values: &#x60;yes&#x60; or &#x60;no&#x60;. - &#x60;yes&#x60;: Increases the performance of the API call by returning a 204 response. - &#x60;no&#x60;: Returns a 200 response that contains the updated customer profiles. | [optional] [default to &#39;yes&#39;] |
| **dry** | **bool**| Indicates whether to persist the changes. Changes are ignored when &#x60;dry&#x3D;true&#x60;. | [optional] |
...
```php
trackEventV3($integrationEventV3Request, $silent, $dry, $forceCompleteEvaluation): \TalonOne\Client\Model\IntegrationEventV3Response
```
...
$integrationEventV3Request = new \TalonOne\Client\Model\IntegrationEventV3Request(); // \TalonOne\Client\Model\IntegrationEventV3Request | body
$silent = 'yes'; // string | Possible values: `yes` or `no`. - `yes`: Increases the performance of the API call by returning a 204 response. - `no`: Returns a 200 response that contains the updated customer profiles.
$dry = True; // bool | Indicates whether to persist the changes. Changes are ignored when `dry=true`.
$forceCompleteEvaluation = false; // bool | Forces evaluation for all matching campaigns regardless of the [campaign evaluation mode](https://docs.talon.one/docs/product/applications/managing-campaign-evaluation#setting-campaign-evaluation-mode). Requires `dry=true`.

try {
    $result = $apiInstance->trackEventV3($integrationEventV3Request, $silent, $dry, $forceCompleteEvaluation);
    print_r($result);
} catch (Exception $e) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **integrationEventV3Request** | [**\TalonOne\Client\Model\IntegrationEventV3Request**](../Model/IntegrationEventV3Request.md)| body | |
| **silent** | **string**| Possible values: &#x60;yes&#x60; or &#x60;no&#x60;. - &#x60;yes&#x60;: Increases the performance of the API call by returning a 204 response. - &#x60;no&#x60;: Returns a 200 response that contains the updated customer profiles. | [optional] [default to &#39;yes&#39;] |
| **dry** | **bool**| Indicates whether to persist the changes. Changes are ignored when &#x60;dry&#x3D;true&#x60;. | [optional] |
| **forceCompleteEvaluation** | **bool**| Forces evaluation for all matching campaigns regardless of the [campaign evaluation mode](https://docs.talon.one/docs/product/applications/managing-campaign-evaluation#setting-campaign-evaluation-mode). Requires &#x60;dry&#x3D;true&#x60;. | [optional] [default to false] |
...
$loyaltyCardId = 'loyaltyCardId_example'; // string | The identifier of the loyalty card. You can get this ID using the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint.  **Important**: The loyalty card ID requires [URL encoding](https://www.w3schools.com/tags//ref_urlencode.asp) if it contains special characters. For example, you must encode `NewCard2026%` as `NewCard2026%25`.
$loyaltyCardRegistration = new \TalonOne\Client\Model\LoyaltyCardRegistration(); // \TalonOne\Client\Model\LoyaltyCardRegistration | body
...
```php
updateAudienceV2($audienceId, $updateAudience): \TalonOne\Client\Model\Audience
```
...
$audienceId = 56; // int | The ID of the audience.
$updateAudience = new \TalonOne\Client\Model\UpdateAudience(); // \TalonOne\Client\Model\UpdateAudience | body

try {
    $result = $apiInstance->updateAudienceV2($audienceId, $updateAudience);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **audienceId** | **int**| The ID of the audience. | |
| **updateAudience** | [**\TalonOne\Client\Model\UpdateAudience**](../Model/UpdateAudience.md)| body | |
...
$customerProfileAudienceRequest = new \TalonOne\Client\Model\CustomerProfileAudienceRequest(); // \TalonOne\Client\Model\CustomerProfileAudienceRequest | body
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **customerProfileAudienceRequest** | [**\TalonOne\Client\Model\CustomerProfileAudienceRequest**](../Model/CustomerProfileAudienceRequest.md)| body | |
