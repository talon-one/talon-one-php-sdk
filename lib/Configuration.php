...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://yourbaseurl.talon.one';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/26.07.01/PHP';
    ...
    {
        $report  = 'PHP SDK (TalonOne\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: ' . PHP_EOL;
        $report .= '    SDK Package Version: 26.07.01' . PHP_EOL;
