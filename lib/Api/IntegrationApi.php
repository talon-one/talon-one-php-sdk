...
class IntegrationApi
{
    ...
    public function activateLoyaltyPointsRequest($loyaltyProgramId, $activateLoyaltyPoints, string $contentType = self::contentTypes['activateLoyaltyPoints'][0])
    {
        ...
        if (isset($activateLoyaltyPoints)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($activateLoyaltyPoints));
            } else {
    ...
    public function deleteLoyaltyTransactionsFromLedgersRequest($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, string $contentType = self::contentTypes['deleteLoyaltyTransactionsFromLedgers'][0])
    {
        ...
        if (isset($deleteLoyaltyTransactionsRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($deleteLoyaltyTransactionsRequest));
            } else {
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\IntegrationEventV2Response|string|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerSessionV2409Response
     */
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \TalonOne\Client\Model\IntegrationEventV2Response|string|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerSessionV2409Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\IntegrationEventV3Response|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerSessionV2409Response
     */
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \TalonOne\Client\Model\IntegrationEventV3Response|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerSessionV2409Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function trackEventV3Request($integrationEventV3Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, string $contentType = self::contentTypes['trackEventV3'][0])
    {
        ...
        if (isset($integrationEventV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($integrationEventV3Request));
            } else {
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\CustomerProfileIntegrationResponseV2|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerSessionV2409Response
     */
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \TalonOne\Client\Model\CustomerProfileIntegrationResponseV2|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerSessionV2409Response, HTTP status code, HTTP response headers (array of strings)
     */
