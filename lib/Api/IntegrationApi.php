...
class IntegrationApi
{
    ...
    /**
     * Operation activateLoyaltyPoints
     *
     * Activate loyalty points
     *
     * @param  int $loyaltyProgramId The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     * @param  \TalonOne\Client\Model\ActivateLoyaltyPoints $activateLoyaltyPoints body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['activateLoyaltyPoints'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\ActivateLoyaltyPointsResponse|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus
     */
    public function activateLoyaltyPoints($loyaltyProgramId, $activateLoyaltyPoints, string $contentType = self::contentTypes['activateLoyaltyPoints'][0])
    {
        list($response) = $this->activateLoyaltyPointsWithHttpInfo($loyaltyProgramId, $activateLoyaltyPoints, $contentType);
        return $response;
    }

    /**
     * Operation activateLoyaltyPointsWithHttpInfo
     *
     * Activate loyalty points
     *
     * @param  int $loyaltyProgramId The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \TalonOne\Client\Model\ActivateLoyaltyPointsResponse|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function activateLoyaltyPointsWithHttpInfo($loyaltyProgramId, $activateLoyaltyPoints, string $contentType = self::contentTypes['activateLoyaltyPoints'][0])
    {
        $request = $this->activateLoyaltyPointsRequest($loyaltyProgramId, $activateLoyaltyPoints, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\TalonOne\Client\Model\ActivateLoyaltyPointsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation activateLoyaltyPointsAsync
     *
     * Activate loyalty points
     *
     * @param  int $loyaltyProgramId The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     */
    public function activateLoyaltyPointsAsync($loyaltyProgramId, $activateLoyaltyPoints, string $contentType = self::contentTypes['activateLoyaltyPoints'][0])
    {
        return $this->activateLoyaltyPointsAsyncWithHttpInfo($loyaltyProgramId, $activateLoyaltyPoints, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation activateLoyaltyPointsAsyncWithHttpInfo
     *
     * Activate loyalty points
     *
     * @param  int $loyaltyProgramId The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activateLoyaltyPointsAsyncWithHttpInfo($loyaltyProgramId, $activateLoyaltyPoints, string $contentType = self::contentTypes['activateLoyaltyPoints'][0])
    {
        $returnType = '\TalonOne\Client\Model\ActivateLoyaltyPointsResponse';
        $request = $this->activateLoyaltyPointsRequest($loyaltyProgramId, $activateLoyaltyPoints, $contentType);
    ...
    /**
     * Create request for operation 'activateLoyaltyPoints'
     *
     * @param  int $loyaltyProgramId The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     * @param  \TalonOne\Client\Model\ActivateLoyaltyPoints $activateLoyaltyPoints body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['activateLoyaltyPoints'] to see the possible values for this operation
     ...
     */
    public function activateLoyaltyPointsRequest($loyaltyProgramId, $activateLoyaltyPoints, string $contentType = self::contentTypes['activateLoyaltyPoints'][0])
    {

        // verify the required parameter 'loyaltyProgramId' is set
        if ($loyaltyProgramId === null || (is_array($loyaltyProgramId) && count($loyaltyProgramId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyaltyProgramId when calling activateLoyaltyPoints'
            );
        }

        // verify the required parameter 'activateLoyaltyPoints' is set
        if ($activateLoyaltyPoints === null || (is_array($activateLoyaltyPoints) && count($activateLoyaltyPoints) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $activateLoyaltyPoints when calling activateLoyaltyPoints'
            );
        }


        $resourcePath = '/v1/loyalty_programs/{loyaltyProgramId}/activate_points';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($activateLoyaltyPoints)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($activateLoyaltyPoints), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
                $httpBody = $activateLoyaltyPoints;
            }
    ...
    public function bestPriorPriceRequest($bestPriorPriceRequest, string $contentType = self::contentTypes['bestPriorPrice'][0])
    {
        ...
        if (isset($bestPriorPriceRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($bestPriorPriceRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function createAudienceV2Request($newAudience, string $contentType = self::contentTypes['createAudienceV2'][0])
    {
        ...
        if (isset($newAudience)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($newAudience), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function createCouponReservationRequest($couponValue, $couponReservations, string $contentType = self::contentTypes['createCouponReservation'][0])
    {
        ...
        if (isset($couponReservations)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($couponReservations), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function createReferralRequest($newReferral, string $contentType = self::contentTypes['createReferral'][0])
    {
        ...
        if (isset($newReferral)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($newReferral), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function createReferralsForMultipleAdvocatesRequest($newReferralsForMultipleAdvocates, $silent = 'yes', string $contentType = self::contentTypes['createReferralsForMultipleAdvocates'][0])
    {
        ...
        if (isset($newReferralsForMultipleAdvocates)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($newReferralsForMultipleAdvocates), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    /**
     * Operation deleteLoyaltyTransactionsFromLedgers
     *
     ...
     * @param  string $integrationId The integration ID of the customer profile. You can get the &#x60;integrationId&#x60; of a profile using: - A customer session integration ID with the [Update customer session](https://docs.talon.one/integration-api#tag/Customer-sessions/operation/updateCustomerSessionV2) endpoint. - The Management API with the [List application&#39;s customers](https://docs.talon.one/management-api#tag/Customer-data/operation/getApplicationCustomers) endpoint. (required)
     * @param  \TalonOne\Client\Model\DeleteLoyaltyTransactionsRequest $deleteLoyaltyTransactionsRequest deleteLoyaltyTransactionsRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteLoyaltyTransactionsFromLedgers'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteLoyaltyTransactionsFromLedgers($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, string $contentType = self::contentTypes['deleteLoyaltyTransactionsFromLedgers'][0])
    {
        $this->deleteLoyaltyTransactionsFromLedgersWithHttpInfo($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, $contentType);
    }

    /**
     * Operation deleteLoyaltyTransactionsFromLedgersWithHttpInfo
     *
     * Delete customer&#39;s transactions from loyalty ledgers
     *
     * @param  int $loyaltyProgramId Identifier of the profile-based loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     * @param  string $integrationId The integration ID of the customer profile. You can get the &#x60;integrationId&#x60; of a profile using: - A customer session integration ID with the [Update customer session](https://docs.talon.one/integration-api#tag/Customer-sessions/operation/updateCustomerSessionV2) endpoint. - The Management API with the [List application&#39;s customers](https://docs.talon.one/management-api#tag/Customer-data/operation/getApplicationCustomers) endpoint. (required)
     * @param  \TalonOne\Client\Model\DeleteLoyaltyTransactionsRequest $deleteLoyaltyTransactionsRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteLoyaltyTransactionsFromLedgers'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteLoyaltyTransactionsFromLedgersWithHttpInfo($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, string $contentType = self::contentTypes['deleteLoyaltyTransactionsFromLedgers'][0])
    {
        $request = $this->deleteLoyaltyTransactionsFromLedgersRequest($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, $contentType);
    ...
    /**
     * Operation deleteLoyaltyTransactionsFromLedgersAsync
     *
     * Delete customer&#39;s transactions from loyalty ledgers
     *
     * @param  int $loyaltyProgramId Identifier of the profile-based loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLoyaltyTransactionsFromLedgersAsync($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, string $contentType = self::contentTypes['deleteLoyaltyTransactionsFromLedgers'][0])
    {
        return $this->deleteLoyaltyTransactionsFromLedgersAsyncWithHttpInfo($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteLoyaltyTransactionsFromLedgersAsyncWithHttpInfo
     *
     * Delete customer&#39;s transactions from loyalty ledgers
     *
     * @param  int $loyaltyProgramId Identifier of the profile-based loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLoyaltyTransactionsFromLedgersAsyncWithHttpInfo($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, string $contentType = self::contentTypes['deleteLoyaltyTransactionsFromLedgers'][0])
    {
        $returnType = '';
        $request = $this->deleteLoyaltyTransactionsFromLedgersRequest($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, $contentType);
    ...
    /**
     * Create request for operation 'deleteLoyaltyTransactionsFromLedgers'
     *
     * @param  int $loyaltyProgramId Identifier of the profile-based loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     * @param  string $integrationId The integration ID of the customer profile. You can get the &#x60;integrationId&#x60; of a profile using: - A customer session integration ID with the [Update customer session](https://docs.talon.one/integration-api#tag/Customer-sessions/operation/updateCustomerSessionV2) endpoint. - The Management API with the [List application&#39;s customers](https://docs.talon.one/management-api#tag/Customer-data/operation/getApplicationCustomers) endpoint. (required)
     * @param  \TalonOne\Client\Model\DeleteLoyaltyTransactionsRequest $deleteLoyaltyTransactionsRequest (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteLoyaltyTransactionsFromLedgersRequest($loyaltyProgramId, $integrationId, $deleteLoyaltyTransactionsRequest, string $contentType = self::contentTypes['deleteLoyaltyTransactionsFromLedgers'][0])
    {

        // verify the required parameter 'loyaltyProgramId' is set
        if ($loyaltyProgramId === null || (is_array($loyaltyProgramId) && count($loyaltyProgramId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyaltyProgramId when calling deleteLoyaltyTransactionsFromLedgers'
            );
        }
        ...
        if ($integrationId === null || (is_array($integrationId) && count($integrationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $integrationId when calling deleteLoyaltyTransactionsFromLedgers'
            );
        }

        // verify the required parameter 'deleteLoyaltyTransactionsRequest' is set
        if ($deleteLoyaltyTransactionsRequest === null || (is_array($deleteLoyaltyTransactionsRequest) && count($deleteLoyaltyTransactionsRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $deleteLoyaltyTransactionsRequest when calling deleteLoyaltyTransactionsFromLedgers'
            );
        }


        $resourcePath = '/v1/loyalty_programs/{loyaltyProgramId}/profile/{integrationId}/delete_transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($deleteLoyaltyTransactionsRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($deleteLoyaltyTransactionsRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
                $httpBody = $deleteLoyaltyTransactionsRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function generateLoyaltyCardRequest($loyaltyProgramId, $generateLoyaltyCard, string $contentType = self::contentTypes['generateLoyaltyCard'][0])
    {
        ...
        if (isset($generateLoyaltyCard)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($generateLoyaltyCard), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
     ...
     * @param  bool|null $unlockedRewards Set to &#x60;true&#x60; to include &#x60;unlocked&#x60; rewards that have not been &#x60;used&#x60; in the response. (optional)
     ...
     */
    public function getCustomerInventory($integrationId, $profile = null, $referrals = null, $coupons = null, $loyalty = null, $giveaways = null, $achievements = null, $unlockedRewards = null, string $contentType = self::contentTypes['getCustomerInventory'][0])
    {
        list($response) = $this->getCustomerInventoryWithHttpInfo($integrationId, $profile, $referrals, $coupons, $loyalty, $giveaways, $achievements, $unlockedRewards, $contentType);
        return $response;
    }
     ...
     */
    public function getCustomerInventoryWithHttpInfo($integrationId, $profile = null, $referrals = null, $coupons = null, $loyalty = null, $giveaways = null, $achievements = null, $unlockedRewards = null, string $contentType = self::contentTypes['getCustomerInventory'][0])
    {
        $request = $this->getCustomerInventoryRequest($integrationId, $profile, $referrals, $coupons, $loyalty, $giveaways, $achievements, $unlockedRewards, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerInventoryAsync($integrationId, $profile = null, $referrals = null, $coupons = null, $loyalty = null, $giveaways = null, $achievements = null, $unlockedRewards = null, string $contentType = self::contentTypes['getCustomerInventory'][0])
    {
        return $this->getCustomerInventoryAsyncWithHttpInfo($integrationId, $profile, $referrals, $coupons, $loyalty, $giveaways, $achievements, $unlockedRewards, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerInventoryAsyncWithHttpInfo($integrationId, $profile = null, $referrals = null, $coupons = null, $loyalty = null, $giveaways = null, $achievements = null, $unlockedRewards = null, string $contentType = self::contentTypes['getCustomerInventory'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomerInventoryRequest($integrationId, $profile = null, $referrals = null, $coupons = null, $loyalty = null, $giveaways = null, $achievements = null, $unlockedRewards = null, string $contentType = self::contentTypes['getCustomerInventory'][0])
    {
    ...
    /**
     * Operation getEventV3
     *
     * Get advanced event
     *
     * @param  string $integrationId The unique ID of the advanced event. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEventV3'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\EventV3|\TalonOne\Client\Model\ErrorResponseWithStatus
     */
    public function getEventV3($integrationId, string $contentType = self::contentTypes['getEventV3'][0])
    {
        list($response) = $this->getEventV3WithHttpInfo($integrationId, $contentType);
        return $response;
    }

    /**
     * Operation getEventV3WithHttpInfo
     *
     * Get advanced event
     *
     * @param  string $integrationId The unique ID of the advanced event. (required)
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \TalonOne\Client\Model\EventV3|\TalonOne\Client\Model\ErrorResponseWithStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEventV3WithHttpInfo($integrationId, string $contentType = self::contentTypes['getEventV3'][0])
    {
        $request = $this->getEventV3Request($integrationId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventV3Async($integrationId, string $contentType = self::contentTypes['getEventV3'][0])
    {
        return $this->getEventV3AsyncWithHttpInfo($integrationId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEventV3AsyncWithHttpInfo
     *
     * Get advanced event
     *
     * @param  string $integrationId The unique ID of the advanced event. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventV3AsyncWithHttpInfo($integrationId, string $contentType = self::contentTypes['getEventV3'][0])
    {
        $returnType = '\TalonOne\Client\Model\EventV3';
        $request = $this->getEventV3Request($integrationId, $contentType);
    ...
    /**
     * Create request for operation 'getEventV3'
     *
     * @param  string $integrationId The unique ID of the advanced event. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEventV3'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEventV3Request($integrationId, string $contentType = self::contentTypes['getEventV3'][0])
    {

        // verify the required parameter 'integrationId' is set
        if ($integrationId === null || (is_array($integrationId) && count($integrationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $integrationId when calling getEventV3'
            );
        }


        $resourcePath = '/v3/events/{integrationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation integrationRewardsCatalog
     *
     * List rewards in the catalog
     *
     * @param  int|null $pageSize The number of items in the response. (optional, default to 1000)
     * @param  int|null $skip The number of items to skip when paging through large result sets. (optional)
     * @param  float|null $pointsFrom Return only rewards whose points required is greater than or equal to this value. (optional)
     * @param  float|null $pointsTo Return only rewards whose points required is less than or equal to this value. (optional)
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\IntegrationRewardsCatalog200Response|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus
     */
    public function integrationRewardsCatalog($pageSize = 1000, $skip = null, $pointsFrom = null, $pointsTo = null, $includeFree = true, $loyaltyProgramId = null, $subledgerId = null, $profileIntegrationId = null, $loyaltyCardId = null, string $contentType = self::contentTypes['integrationRewardsCatalog'][0])
    {
        list($response) = $this->integrationRewardsCatalogWithHttpInfo($pageSize, $skip, $pointsFrom, $pointsTo, $includeFree, $loyaltyProgramId, $subledgerId, $profileIntegrationId, $loyaltyCardId, $contentType);
        return $response;
    }

    /**
     * Operation integrationRewardsCatalogWithHttpInfo
     *
     * List rewards in the catalog
     *
     * @param  int|null $pageSize The number of items in the response. (optional, default to 1000)
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \TalonOne\Client\Model\IntegrationRewardsCatalog200Response|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function integrationRewardsCatalogWithHttpInfo($pageSize = 1000, $skip = null, $pointsFrom = null, $pointsTo = null, $includeFree = true, $loyaltyProgramId = null, $subledgerId = null, $profileIntegrationId = null, $loyaltyCardId = null, string $contentType = self::contentTypes['integrationRewardsCatalog'][0])
    {
        $request = $this->integrationRewardsCatalogRequest($pageSize, $skip, $pointsFrom, $pointsTo, $includeFree, $loyaltyProgramId, $subledgerId, $profileIntegrationId, $loyaltyCardId, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\TalonOne\Client\Model\IntegrationRewardsCatalog200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation integrationRewardsCatalogAsync
     *
     * List rewards in the catalog
     *
     * @param  int|null $pageSize The number of items in the response. (optional, default to 1000)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function integrationRewardsCatalogAsync($pageSize = 1000, $skip = null, $pointsFrom = null, $pointsTo = null, $includeFree = true, $loyaltyProgramId = null, $subledgerId = null, $profileIntegrationId = null, $loyaltyCardId = null, string $contentType = self::contentTypes['integrationRewardsCatalog'][0])
    {
        return $this->integrationRewardsCatalogAsyncWithHttpInfo($pageSize, $skip, $pointsFrom, $pointsTo, $includeFree, $loyaltyProgramId, $subledgerId, $profileIntegrationId, $loyaltyCardId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation integrationRewardsCatalogAsyncWithHttpInfo
     *
     * List rewards in the catalog
     *
     * @param  int|null $pageSize The number of items in the response. (optional, default to 1000)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function integrationRewardsCatalogAsyncWithHttpInfo($pageSize = 1000, $skip = null, $pointsFrom = null, $pointsTo = null, $includeFree = true, $loyaltyProgramId = null, $subledgerId = null, $profileIntegrationId = null, $loyaltyCardId = null, string $contentType = self::contentTypes['integrationRewardsCatalog'][0])
    {
        $returnType = '\TalonOne\Client\Model\IntegrationRewardsCatalog200Response';
        $request = $this->integrationRewardsCatalogRequest($pageSize, $skip, $pointsFrom, $pointsTo, $includeFree, $loyaltyProgramId, $subledgerId, $profileIntegrationId, $loyaltyCardId, $contentType);
    ...
    /**
     * Create request for operation 'integrationRewardsCatalog'
     *
     * @param  int|null $pageSize The number of items in the response. (optional, default to 1000)
     * @param  int|null $skip The number of items to skip when paging through large result sets. (optional)
     * @param  float|null $pointsFrom Return only rewards whose points required is greater than or equal to this value. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function integrationRewardsCatalogRequest($pageSize = 1000, $skip = null, $pointsFrom = null, $pointsTo = null, $includeFree = true, $loyaltyProgramId = null, $subledgerId = null, $profileIntegrationId = null, $loyaltyCardId = null, string $contentType = self::contentTypes['integrationRewardsCatalog'][0])
    {

        if ($pageSize !== null && $pageSize > 1000) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling IntegrationApi.integrationRewardsCatalog, must be smaller than or equal to 1000.');
        }
        if ($pageSize !== null && $pageSize < 1) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling IntegrationApi.integrationRewardsCatalog, must be bigger than or equal to 1.');
        }
        

        if ($pointsFrom !== null && $pointsFrom <= 0) {
            throw new \InvalidArgumentException('invalid value for "$pointsFrom" when calling IntegrationApi.integrationRewardsCatalog, must be bigger than 0.');
        }
        
        if ($pointsTo !== null && $pointsTo <= 0) {
            throw new \InvalidArgumentException('invalid value for "$pointsTo" when calling IntegrationApi.integrationRewardsCatalog, must be bigger than 0.');
        }
        ...
        $resourcePath = '/v1/rewards/catalog';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function linkLoyaltyCardToProfileRequest($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, string $contentType = self::contentTypes['linkLoyaltyCardToProfile'][0])
    {
        ...
        if (isset($loyaltyCardRegistration)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($loyaltyCardRegistration), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function returnCartItemsRequest($customerSessionId, $returnIntegrationRequest, $dry = null, $runRuleEngine = null, $idempotencyKey = null, string $contentType = self::contentTypes['returnCartItems'][0])
    {
        ...
        if (isset($returnIntegrationRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($returnIntegrationRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function syncCatalogRequest($catalogId, $catalogSyncRequest, string $contentType = self::contentTypes['syncCatalog'][0])
    {
        ...
        if (isset($catalogSyncRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($catalogSyncRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function trackEventV2WithHttpInfo($integrationEventV2Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, $idempotencyKey = null, string $contentType = self::contentTypes['trackEventV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\TalonOne\Client\Model\IntegrationEventV2Response',
                        $request,
                        $response,
                    );
                case 204:
    ...
    public function trackEventV2Request($integrationEventV2Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, $idempotencyKey = null, string $contentType = self::contentTypes['trackEventV2'][0])
    {
        ...
        if (isset($integrationEventV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($integrationEventV2Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    /**
     * Operation trackEventV3
     *
     * Track advanced event
     *
     * @param  \TalonOne\Client\Model\IntegrationEventV3Request $integrationEventV3Request body (required)
     * @param  string|null $silent Possible values: &#x60;yes&#x60; or &#x60;no&#x60;. - &#x60;yes&#x60;: Increases the performance of the API call by returning a 204 response. - &#x60;no&#x60;: Returns a 200 response that contains the updated customer profiles. (optional, default to 'yes')
     * @param  bool|null $dry Indicates whether to persist the changes. Changes are ignored when &#x60;dry&#x3D;true&#x60;. (optional)
     * @param  bool|null $forceCompleteEvaluation Forces evaluation for all matching campaigns regardless of the [campaign evaluation mode](https://docs.talon.one/docs/product/applications/managing-campaign-evaluation#setting-campaign-evaluation-mode). Requires &#x60;dry&#x3D;true&#x60;. (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackEventV3'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\IntegrationEventV3Response|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerProfileV2409Response
     */
    public function trackEventV3($integrationEventV3Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, string $contentType = self::contentTypes['trackEventV3'][0])
    {
        list($response) = $this->trackEventV3WithHttpInfo($integrationEventV3Request, $silent, $dry, $forceCompleteEvaluation, $contentType);
        return $response;
    }

    /**
     * Operation trackEventV3WithHttpInfo
     *
     * Track advanced event
     *
     * @param  \TalonOne\Client\Model\IntegrationEventV3Request $integrationEventV3Request body (required)
     ...
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \TalonOne\Client\Model\IntegrationEventV3Response|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\UpdateCustomerProfileV2409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function trackEventV3WithHttpInfo($integrationEventV3Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, string $contentType = self::contentTypes['trackEventV3'][0])
    {
        $request = $this->trackEventV3Request($integrationEventV3Request, $silent, $dry, $forceCompleteEvaluation, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\TalonOne\Client\Model\IntegrationEventV3Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackEventV3Async($integrationEventV3Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, string $contentType = self::contentTypes['trackEventV3'][0])
    {
        return $this->trackEventV3AsyncWithHttpInfo($integrationEventV3Request, $silent, $dry, $forceCompleteEvaluation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation trackEventV3AsyncWithHttpInfo
     *
     * Track advanced event
     *
     * @param  \TalonOne\Client\Model\IntegrationEventV3Request $integrationEventV3Request body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackEventV3AsyncWithHttpInfo($integrationEventV3Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, string $contentType = self::contentTypes['trackEventV3'][0])
    {
        $returnType = '\TalonOne\Client\Model\IntegrationEventV3Response';
        $request = $this->trackEventV3Request($integrationEventV3Request, $silent, $dry, $forceCompleteEvaluation, $contentType);
    ...
    /**
     * Create request for operation 'trackEventV3'
     *
     * @param  \TalonOne\Client\Model\IntegrationEventV3Request $integrationEventV3Request body (required)
     * @param  string|null $silent Possible values: &#x60;yes&#x60; or &#x60;no&#x60;. - &#x60;yes&#x60;: Increases the performance of the API call by returning a 204 response. - &#x60;no&#x60;: Returns a 200 response that contains the updated customer profiles. (optional, default to 'yes')
     * @param  bool|null $dry Indicates whether to persist the changes. Changes are ignored when &#x60;dry&#x3D;true&#x60;. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackEventV3Request($integrationEventV3Request, $silent = 'yes', $dry = null, $forceCompleteEvaluation = false, string $contentType = self::contentTypes['trackEventV3'][0])
    {

        // verify the required parameter 'integrationEventV3Request' is set
        if ($integrationEventV3Request === null || (is_array($integrationEventV3Request) && count($integrationEventV3Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $integrationEventV3Request when calling trackEventV3'
            );
        }
        ...
        // for model (json/xml)
        if (isset($integrationEventV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($integrationEventV3Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
                $httpBody = $integrationEventV3Request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation unlinkLoyaltyCardFromProfile
     *
     * Unlink customer profile from a loyalty card
     *
     * @param  int $loyaltyProgramId The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     * @param  string $loyaltyCardId The identifier of the loyalty card. You can get this ID using the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint.  **Important**: The loyalty card ID requires [URL encoding](https://www.w3schools.com/tags//ref_urlencode.asp) if it contains special characters. For example, you must encode &#x60;NewCard2026%&#x60; as &#x60;NewCard2026%25&#x60;. (required)
     * @param  \TalonOne\Client\Model\LoyaltyCardRegistration $loyaltyCardRegistration body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unlinkLoyaltyCardFromProfile'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TalonOne\Client\Model\LoyaltyCard|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus
     */
    public function unlinkLoyaltyCardFromProfile($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, string $contentType = self::contentTypes['unlinkLoyaltyCardFromProfile'][0])
    {
        list($response) = $this->unlinkLoyaltyCardFromProfileWithHttpInfo($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, $contentType);
        return $response;
    }

    /**
     * Operation unlinkLoyaltyCardFromProfileWithHttpInfo
     *
     * Unlink customer profile from a loyalty card
     *
     * @param  int $loyaltyProgramId The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     * @return array of \TalonOne\Client\Model\LoyaltyCard|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus|\TalonOne\Client\Model\ErrorResponseWithStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function unlinkLoyaltyCardFromProfileWithHttpInfo($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, string $contentType = self::contentTypes['unlinkLoyaltyCardFromProfile'][0])
    {
        $request = $this->unlinkLoyaltyCardFromProfileRequest($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, $contentType);
    ...
    /**
     * Operation unlinkLoyaltyCardFromProfileAsync
     *
     * Unlink customer profile from a loyalty card
     *
     * @param  int $loyaltyProgramId The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unlinkLoyaltyCardFromProfileAsync($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, string $contentType = self::contentTypes['unlinkLoyaltyCardFromProfile'][0])
    {
        return $this->unlinkLoyaltyCardFromProfileAsyncWithHttpInfo($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unlinkLoyaltyCardFromProfileAsyncWithHttpInfo
     *
     * Unlink customer profile from a loyalty card
     *
     * @param  int $loyaltyProgramId The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unlinkLoyaltyCardFromProfileAsyncWithHttpInfo($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, string $contentType = self::contentTypes['unlinkLoyaltyCardFromProfile'][0])
    {
        $returnType = '\TalonOne\Client\Model\LoyaltyCard';
        $request = $this->unlinkLoyaltyCardFromProfileRequest($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, $contentType);
    ...
    /**
     * Create request for operation 'unlinkLoyaltyCardFromProfile'
     *
     * @param  int $loyaltyProgramId The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. (required)
     * @param  string $loyaltyCardId The identifier of the loyalty card. You can get this ID using the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint.  **Important**: The loyalty card ID requires [URL encoding](https://www.w3schools.com/tags//ref_urlencode.asp) if it contains special characters. For example, you must encode &#x60;NewCard2026%&#x60; as &#x60;NewCard2026%25&#x60;. (required)
     * @param  \TalonOne\Client\Model\LoyaltyCardRegistration $loyaltyCardRegistration body (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unlinkLoyaltyCardFromProfileRequest($loyaltyProgramId, $loyaltyCardId, $loyaltyCardRegistration, string $contentType = self::contentTypes['unlinkLoyaltyCardFromProfile'][0])
    {

        // verify the required parameter 'loyaltyProgramId' is set
        if ($loyaltyProgramId === null || (is_array($loyaltyProgramId) && count($loyaltyProgramId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyaltyProgramId when calling unlinkLoyaltyCardFromProfile'
            );
        }
        ...
        if ($loyaltyCardId === null || (is_array($loyaltyCardId) && count($loyaltyCardId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyaltyCardId when calling unlinkLoyaltyCardFromProfile'
            );
        }
        if (strlen($loyaltyCardId) > 108) {
            throw new \InvalidArgumentException('invalid length for "$loyaltyCardId" when calling IntegrationApi.unlinkLoyaltyCardFromProfile, must be smaller than or equal to 108.');
        }
        if (strlen($loyaltyCardId) < 4) {
            throw new \InvalidArgumentException('invalid length for "$loyaltyCardId" when calling IntegrationApi.unlinkLoyaltyCardFromProfile, must be bigger than or equal to 4.');
        }
        
        // verify the required parameter 'loyaltyCardRegistration' is set
        if ($loyaltyCardRegistration === null || (is_array($loyaltyCardRegistration) && count($loyaltyCardRegistration) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyaltyCardRegistration when calling unlinkLoyaltyCardFromProfile'
            );
        }


        $resourcePath = '/v2/loyalty_programs/{loyaltyProgramId}/cards/{loyaltyCardId}/unlink_profile';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation unlockReward
     *
     * Unlock a reward
     *
     * @param  int $rewardId The ID of the reward. You can get the ID with the [List rewards](#tag/Rewards/operation/listRewards) endpoint. (required)
     * @param  \TalonOne\Client\Model\IntegrationUnlockRewardRequest $integrationUnlockRewardRequest integrationUnlockRewardRequest (required)
     * @param  bool|null $dry When set to &#x60;true&#x60;, the rule evaluation is performed but no changes are persisted. Use this to preview the outcome of an unlocking. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unlockReward'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->unlockRewardWithHttpInfo($rewardId, $integrationUnlockRewardRequest, $dry, $contentType);
        return $response;
    }

    /**
     * Operation unlockRewardWithHttpInfo
     *
     * Unlock a reward
     *
     * @param  int $rewardId The ID of the reward. You can get the ID with the [List rewards](#tag/Rewards/operation/listRewards) endpoint. (required)
     * @param  \TalonOne\Client\Model\IntegrationUnlockRewardRequest $integrationUnlockRewardRequest (required)
     * @param  bool|null $dry When set to &#x60;true&#x60;, the rule evaluation is performed but no changes are persisted. Use this to preview the outcome of an unlocking. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unlockReward'] to see the possible values for this operation
     *
     * @throws \TalonOne\Client\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    public function unlockRewardWithHttpInfo($rewardId, $integrationUnlockRewardRequest, $dry = null, string $contentType = self::contentTypes['unlockReward'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 422:
                    return $this->handleResponseWithDataType(
                        '\TalonOne\Client\Model\RewardUnlockRejection',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unlockRewardAsync($rewardId, $integrationUnlockRewardRequest, $dry = null, string $contentType = self::contentTypes['unlockReward'][0])
    {
        return $this->unlockRewardAsyncWithHttpInfo($rewardId, $integrationUnlockRewardRequest, $dry, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unlockRewardAsyncWithHttpInfo
     *
     * Unlock a reward
     *
     * @param  int $rewardId The ID of the reward. You can get the ID with the [List rewards](#tag/Rewards/operation/listRewards) endpoint. (required)
    ...
    /**
     * Create request for operation 'unlockReward'
     *
     * @param  int $rewardId The ID of the reward. You can get the ID with the [List rewards](#tag/Rewards/operation/listRewards) endpoint. (required)
     * @param  \TalonOne\Client\Model\IntegrationUnlockRewardRequest $integrationUnlockRewardRequest (required)
     * @param  bool|null $dry When set to &#x60;true&#x60;, the rule evaluation is performed but no changes are persisted. Use this to preview the outcome of an unlocking. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unlockRewardRequest($rewardId, $integrationUnlockRewardRequest, $dry = null, string $contentType = self::contentTypes['unlockReward'][0])
    {

        // verify the required parameter 'rewardId' is set
        if ($rewardId === null || (is_array($rewardId) && count($rewardId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $rewardId when calling unlockReward'
            );
        }

        // verify the required parameter 'integrationUnlockRewardRequest' is set
        if ($integrationUnlockRewardRequest === null || (is_array($integrationUnlockRewardRequest) && count($integrationUnlockRewardRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $integrationUnlockRewardRequest when calling unlockReward'
            );
        }



        $resourcePath = '/v1/rewards/{rewardId}/unlock';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($integrationUnlockRewardRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($integrationUnlockRewardRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
                $httpBody = $integrationUnlockRewardRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function updateAudienceV2Request($audienceId, $updateAudience, string $contentType = self::contentTypes['updateAudienceV2'][0])
    {
        ...
        if (isset($updateAudience)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($updateAudience), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function updateCustomerProfileAudiencesRequest($customerProfileAudienceRequest, string $contentType = self::contentTypes['updateCustomerProfileAudiences'][0])
    {
        ...
        if (isset($customerProfileAudienceRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($customerProfileAudienceRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function updateCustomerProfileV2Request($integrationId, $customerProfileIntegrationRequestV2, $runRuleEngine = false, $dry = null, $idempotencyKey = null, string $contentType = self::contentTypes['updateCustomerProfileV2'][0])
    {
        ...
        if (isset($customerProfileIntegrationRequestV2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($customerProfileIntegrationRequestV2), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function updateCustomerProfilesV2Request($multipleCustomerProfileIntegrationRequest, $silent = 'yes', $idempotencyKey = null, string $contentType = self::contentTypes['updateCustomerProfilesV2'][0])
    {
        ...
        if (isset($multipleCustomerProfileIntegrationRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($multipleCustomerProfileIntegrationRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function updateCustomerSessionV2Request($customerSessionId, $integrationRequest, $dry = null, $now = null, $idempotencyKey = null, string $contentType = self::contentTypes['updateCustomerSessionV2'][0])
    {
        ...
        if (isset($integrationRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($integrationRequest), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
