...
class IntegrationApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\BestPriorPrice[]' === '\SplFileObject') {
                        ...
                        if ('\TalonOne\Client\Model\BestPriorPrice[]' !== 'string') {
                            try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\TalonOne\Client\Model\Audience' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\Audience' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                ...
                case 400:
                    if ('\TalonOne\Client\Model\ErrorResponseWithStatus' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\ErrorResponseWithStatus' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 201:
                    if ('\TalonOne\Client\Model\Coupon' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\Coupon' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 201:
                    if ('\TalonOne\Client\Model\Referral' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\Referral' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                ...
                case 400:
                    if ('\TalonOne\Client\Model\ErrorResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\ErrorResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function createReferralsForMultipleAdvocatesWithHttpInfo($newReferralsForMultipleAdvocates, $silent = 'yes', string $contentType = self::contentTypes['createReferralsForMultipleAdvocates'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\TalonOne\Client\Model\CreateReferralsForMultipleAdvocates201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\CreateReferralsForMultipleAdvocates201Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\CreateReferralsForMultipleAdvocates201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\LoyaltyCard' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\LoyaltyCard' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getCustomerAchievementHistoryWithHttpInfo($integrationId, $achievementId, $progressStatus = null, $startDate = null, $endDate = null, $pageSize = 1000, $skip = null, string $contentType = self::contentTypes['getCustomerAchievementHistory'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\GetCustomerAchievementHistory200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\GetCustomerAchievementHistory200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\GetCustomerAchievementHistory200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    public function getCustomerAchievementsWithHttpInfo($integrationId, $campaignIds = null, $achievementIds = null, $achievementStatus = null, $currentProgressStatus = null, $pageSize = 1000, $skip = null, string $contentType = self::contentTypes['getCustomerAchievements'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\GetCustomerAchievements200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\GetCustomerAchievements200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\GetCustomerAchievements200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\CustomerInventory' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\CustomerInventory' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\IntegrationCustomerSessionResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\IntegrationCustomerSessionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\LoyaltyBalancesWithTiers' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\LoyaltyBalancesWithTiers' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\LoyaltyCardBalances' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\LoyaltyCardBalances' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getLoyaltyCardPointsWithHttpInfo($loyaltyProgramId, $loyaltyCardId, $status = 'active', $subledgerId = null, $customerSessionIDs = null, $transactionUUIDs = null, $pageSize = 50, $skip = null, $sort = null, string $contentType = self::contentTypes['getLoyaltyCardPoints'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\GetLoyaltyCardPoints200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\GetLoyaltyCardPoints200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\GetLoyaltyCardPoints200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    public function getLoyaltyCardTransactionsWithHttpInfo($loyaltyProgramId, $loyaltyCardId, $subledgerId = null, $loyaltyTransactionType = null, $startDate = null, $endDate = null, $customerSessionIDs = null, $transactionUUIDs = null, $pageSize = 50, $skip = null, $awaitsActivation = null, string $contentType = self::contentTypes['getLoyaltyCardTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\GetLoyaltyCardTransactions200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\GetLoyaltyCardTransactions200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\GetLoyaltyCardTransactions200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    public function getLoyaltyProgramProfilePointsWithHttpInfo($loyaltyProgramId, $integrationId, $status = 'active', $subledgerId = null, $customerSessionIDs = null, $transactionUUIDs = null, $pageSize = 50, $skip = null, $sort = null, string $contentType = self::contentTypes['getLoyaltyProgramProfilePoints'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\GetLoyaltyProgramProfilePoints200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\GetLoyaltyProgramProfilePoints200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\GetLoyaltyProgramProfilePoints200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    public function getLoyaltyProgramProfileTransactionsWithHttpInfo($loyaltyProgramId, $integrationId, $customerSessionIDs = null, $transactionUUIDs = null, $subledgerId = null, $loyaltyTransactionType = null, $startDate = null, $endDate = null, $pageSize = 50, $skip = null, $awaitsActivation = null, string $contentType = self::contentTypes['getLoyaltyProgramProfileTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\GetLoyaltyProgramProfileTransactions200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\GetLoyaltyProgramProfileTransactions200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\GetLoyaltyProgramProfileTransactions200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    public function getReservedCustomersWithHttpInfo($couponValue, string $contentType = self::contentTypes['getReservedCustomers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\GetReservedCustomers200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\GetReservedCustomers200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\GetReservedCustomers200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\ReopenSessionResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\ReopenSessionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\IntegrationStateV2' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\IntegrationStateV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\Catalog' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\Catalog' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\TrackEventV2Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\TrackEventV2Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                ...
                case 409:
                    if ('\TalonOne\Client\Model\UpdateCustomerProfileV2409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\UpdateCustomerProfileV2409Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\UpdateCustomerProfileV2409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\CustomerProfileIntegrationResponseV2' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\CustomerProfileIntegrationResponseV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\TalonOne\Client\Model\MultipleCustomerProfileIntegrationResponseV2' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\MultipleCustomerProfileIntegrationResponseV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function updateCustomerSessionV2WithHttpInfo($customerSessionId, $integrationRequest, $dry = null, $now = null, string $contentType = self::contentTypes['updateCustomerSessionV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 409:
                    if ('\TalonOne\Client\Model\UpdateCustomerSessionV2409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\TalonOne\Client\Model\UpdateCustomerSessionV2409Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\TalonOne\Client\Model\UpdateCustomerSessionV2409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
