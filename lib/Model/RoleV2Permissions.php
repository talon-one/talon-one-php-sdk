 ...
 */
class RoleV2Permissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['permissionSets']) && (count($this->container['permissionSets']) > 500)) {
            $invalidProperties[] = "invalid value for 'permissionSets', number of items must be less than or equal to 500.";
        }
    ...
    public function setPermissionSets($permissionSets)
    {
        ...
        if ((count($permissionSets) > 500)) {
            throw new \InvalidArgumentException('invalid value for $permissionSets when calling RoleV2Permissions., number of items must be less than or equal to 500.');
        }
