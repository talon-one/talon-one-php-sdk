 ...
 */
class AudienceCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'lastActivity' => false,
        'sandbox' => false,
        'connectedApplicationsIds' => false,
        'connectedAudiences' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('connectedApplicationsIds', $data ?? [], null);
        $this->setIfExists('connectedAudiences', $data ?? [], null);
    }
     ...
     * Sets attributes
     *
     * @param array<string,mixed>|null $attributes Arbitrary properties associated with this item.
     *
     * @return self
     */
    ...
    {
        if (is_null($connectedApplicationsIds)) {
            throw new \InvalidArgumentException('non-nullable connectedApplicationsIds cannot be null');
        }
    ...
    {
        if (is_null($connectedAudiences)) {
            throw new \InvalidArgumentException('non-nullable connectedAudiences cannot be null');
        }
