 ...
 */
class MultipleCustomerProfileIntegrationRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultipleCustomerProfileIntegrationRequestItem';
    ...
    */
     ...
     * Sets integrationId
     *
     * @param string $integrationId The identifier of this profile, set by your integration layer. It must be unique within the account.  To get the `integrationId` of the profile from a `sessionId`, use the [Update customer session](https://docs.talon.one/integration-api#operation/updateCustomerSessionV2).
     *
     * @return self
     */
