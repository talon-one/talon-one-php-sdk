...
/**
 * EventV3RequestEntity Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventV3RequestEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EventV3RequestEntity';
    ...
    public function setStoreIntegrationId($storeIntegrationId)
    {
        ...
        if ((mb_strlen($storeIntegrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $storeIntegrationId when calling EventV3RequestEntity., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($storeIntegrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $storeIntegrationId when calling EventV3RequestEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling EventV3RequestEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setIntegrationId($integrationId)
    {
        ...
        if ((mb_strlen($integrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling EventV3RequestEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setConnectedSessionId($connectedSessionId)
    {
        ...
        if ((mb_strlen($connectedSessionId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $connectedSessionId when calling EventV3RequestEntity., must be bigger than or equal to 1.');
        }
