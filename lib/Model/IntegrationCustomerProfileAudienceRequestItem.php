...
/**
 * IntegrationCustomerProfileAudienceRequestItem Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationCustomerProfileAudienceRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationCustomerProfileAudienceRequestItem';
    ...
    */
    ...
    public function setProfileIntegrationId($profileIntegrationId)
    {
        ...
        if ((mb_strlen($profileIntegrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $profileIntegrationId when calling IntegrationCustomerProfileAudienceRequestItem., must be smaller than or equal to 1000.');
        }
