 ...
 */
class NewCoupons implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('uniquePrefix', $data ?? [], null);
    ...
    public function setDiscountLimit($discountLimit)
    {
        ...
        if (($discountLimit > 1000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $discountLimit when calling NewCoupons., must be smaller than or equal to 1000000000000000.');
        }
        if (($discountLimit < 0)) {
    ...
    {
        if (is_null($uniquePrefix)) {
            throw new \InvalidArgumentException('non-nullable uniquePrefix cannot be null');
        }
