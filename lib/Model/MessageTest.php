 ...
 */
class MessageTest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageTest';
    ...
    {
        $this->setIfExists('httpResponse', $data ?? [], null);
    ...
    */
    ...
    public function setHttpResponse($httpResponse)
    {
        if (is_null($httpResponse)) {
            throw new \InvalidArgumentException('non-nullable httpResponse cannot be null');
        }
