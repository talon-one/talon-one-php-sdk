 ...
 */
class ApplicationCampaignStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('staged', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($staged)) {
            throw new \InvalidArgumentException('non-nullable staged cannot be null');
        }
