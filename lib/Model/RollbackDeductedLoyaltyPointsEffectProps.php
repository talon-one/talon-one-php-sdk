 ...
 */
class RollbackDeductedLoyaltyPointsEffectProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCardIdentifier($cardIdentifier)
    {
        ...
        if ((mb_strlen($cardIdentifier) < 4)) {
            throw new \InvalidArgumentException('invalid length for $cardIdentifier when calling RollbackDeductedLoyaltyPointsEffectProps., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^[A-Za-z0-9._%+@-]+$/", ObjectSerializer::toString($cardIdentifier)))) {
            throw new \InvalidArgumentException("invalid value for \$cardIdentifier when calling RollbackDeductedLoyaltyPointsEffectProps., must conform to the pattern /^[A-Za-z0-9._%+@-]+$/.");
        }
