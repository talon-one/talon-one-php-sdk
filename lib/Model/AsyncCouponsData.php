 ...
 */
class AsyncCouponsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const NOTIFICATION_TYPE_ASYNC_COUPONS_CREATED = 'AsyncCouponsCreated';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_ASYNC_COUPONS_CREATED,
        ];
    }
