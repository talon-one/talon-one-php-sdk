...
/**
 * LoyaltyCardProfileRegistration Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoyaltyCardProfileRegistration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltyCardProfileRegistration';
    ...
    */
     ...
     * Sets integrationId
     *
     * @param string $integrationId Integration ID of the customer profile linked to the card.
     *
     * @return self
     */
