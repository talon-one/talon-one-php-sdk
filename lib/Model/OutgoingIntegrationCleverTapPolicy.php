...
/**
 * OutgoingIntegrationCleverTapPolicy Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class OutgoingIntegrationCleverTapPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutgoingIntegrationCleverTapPolicy';
    ...
    */
     ...
     * Sets baseUrl
     *
     * @param string $baseUrl The base URL that is based on the region key of your CleverTap account.
     *
     * @return self
     */
