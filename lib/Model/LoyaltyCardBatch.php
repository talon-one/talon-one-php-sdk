 ...
 */
class LoyaltyCardBatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('numberOfCards', $data ?? [], null);
    ...
    */
    ...
    public function setBatchId($batchId)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9_-]*$/", ObjectSerializer::toString($batchId)))) {
