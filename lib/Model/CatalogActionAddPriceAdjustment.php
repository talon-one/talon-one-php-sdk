...
/**
 * CatalogActionAddPriceAdjustment Class Doc Comment
 *
 * @category Class
 ...
 */
class CatalogActionAddPriceAdjustment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CatalogActionAddPriceAdjustment';
     ...
     * Sets type
     *
     * @param string $type A catalog sync action discriminator of type `ADD_PRICE_ADJUSTMENT`.
     *
     * @return self
     */
     ...
     * Gets payload
     *
     * @return \TalonOne\Client\Model\AddPriceAdjustmentCatalogAction
     */
