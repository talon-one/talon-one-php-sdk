...
class DeductLoyaltyPointsEffectProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets programId
     *
     * @param int $programId The ID of the loyalty program from which these points were deducted.
     *
     * @return self
     */
     ...
     * Sets subLedgerId
     *
     * @param string $subLedgerId The ID of the subledger within the loyalty program from which these points were deducted.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The reason of this loyalty points deduction.
     *
     * @return self
     */
     ...
     * Sets cardIdentifier
     *
     * @param string|null $cardIdentifier The identifier of the card from which these points were deducted.
     *
     * @return self
     */
    public function setCardIdentifier($cardIdentifier)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9._%+@-]+$/", ObjectSerializer::toString($cardIdentifier)))) {
            throw new \InvalidArgumentException("invalid value for \$cardIdentifier when calling DeductLoyaltyPointsEffectProps., must conform to the pattern /^[A-Za-z0-9._%+@-]+$/.");
        }
