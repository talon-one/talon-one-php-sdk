 ...
 */
class AddItemCatalogAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('replaceIfExists', $data ?? [], false);
    }
    ...
    */
    ...
    {
        if (is_null($replaceIfExists)) {
            throw new \InvalidArgumentException('non-nullable replaceIfExists cannot be null');
        }
