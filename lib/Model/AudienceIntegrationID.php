...
/**
 * AudienceIntegrationID Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class AudienceIntegrationID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudienceIntegrationID';
    ...
    */
    ...
    public function setIntegrationId($integrationId)
    {
        ...
        if ((mb_strlen($integrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling AudienceIntegrationID., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($integrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling AudienceIntegrationID., must be bigger than or equal to 1.');
        }
