 ...
 */
class NewAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSuggestions($suggestions)
    {
        ...
        if ((count($suggestions) > 50)) {
            throw new \InvalidArgumentException('invalid value for $suggestions when calling NewAttribute., number of items must be less than or equal to 50.');
        }
    ...
    public function setAllowedSubscriptions($allowedSubscriptions)
    {
        ...
        if ((count($allowedSubscriptions) > 2)) {
            throw new \InvalidArgumentException('invalid value for $allowedSubscriptions when calling NewAttribute., number of items must be less than or equal to 2.');
        }
