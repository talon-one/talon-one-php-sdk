...
/**
 * PendingActivePointsNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class PendingActivePointsNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PendingActivePointsNotification';
    ...
    protected static $openAPITypes = [
        'totalResultSize' => 'int',
        'data' => '\TalonOne\Client\Model\PendingActivePointsData[]',
    ...
    public const NOTIFICATION_TYPE_LOYALTY_POINTS_PENDING_TO_ACTIVE = 'LoyaltyPointsPendingToActive';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_LOYALTY_POINTS_PENDING_TO_ACTIVE,
        ];
    }
    ...
    */
     ...
     * Gets data
     *
     * @return \TalonOne\Client\Model\PendingActivePointsData[]
     */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\PendingActivePointsData[] $data The array of pending points.
     *
     * @return self
     */
