...
/**
 * NewEventV3Entity Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewEventV3Entity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NewEventV3Entity';
    ...
    public function setIntegrationId($integrationId)
    {
        ...
        if ((mb_strlen($integrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling NewEventV3Entity., must be bigger than or equal to 1.');
        }
