 ...
 */
class AddLoyaltyPointsEffectProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets cardIdentifier
     *
     * @param string|null $cardIdentifier The identifier of the card on which these points were added.
     *
     * @return self
     */
