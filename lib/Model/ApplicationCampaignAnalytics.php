 ...
 */
class ApplicationCampaignAnalytics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CAMPAIGN_STATE_EXPIRED = 'expired';
    public const CAMPAIGN_STATE_SCHEDULED = 'scheduled';
    public const CAMPAIGN_STATE_RUNNING = 'running';
    public const CAMPAIGN_STATE_DISABLED = 'disabled';
    public const CAMPAIGN_STATE_ARCHIVED = 'archived';
    public const CAMPAIGN_STATE_STAGED = 'staged';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('campaignTags', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['campaignTags']) > 50)) {
            $invalidProperties[] = "invalid value for 'campaignTags', number of items must be less than or equal to 50.";
        }
    ...
    {
        if (is_null($campaignTags)) {
            throw new \InvalidArgumentException('non-nullable campaignTags cannot be null');
        }

        if ((count($campaignTags) > 50)) {
            throw new \InvalidArgumentException('invalid value for $campaignTags when calling ApplicationCampaignAnalytics., number of items must be less than or equal to 50.');
        }
     ...
     * Sets totalRevenue
     *
     * @param \TalonOne\Client\Model\AnalyticsDataPointWithTrendAndInfluencedRate|null $totalRevenue The total, pre-discount value of all items purchased in a customer session.
     *
     * @return self
     */
     ...
     * Sets sessionsCount
     *
     * @param \TalonOne\Client\Model\AnalyticsDataPointWithTrendAndInfluencedRate|null $sessionsCount The number of all closed sessions. The `influenced` value includes only sessions with at least one applied effect.
     *
     * @return self
     */
     ...
     *
     * @param \TalonOne\Client\Model\AnalyticsDataPointWithTrendAndUplift|null $avgItemsPerSession The number of items from sessions divided by the number of sessions. The `influenced` value includes only sessions with at least one applied effect.
     *
     * @return self
     */
     ...
     *
     * @param \TalonOne\Client\Model\AnalyticsDataPointWithTrendAndUplift|null $avgSessionValue The average customer session value, calculated by dividing the revenue value by the number of sessions. The `influenced` value includes only sessions with at least one applied effect.
     *
     * @return self
     */
     ...
     * Sets totalDiscounts
     *
     * @param \TalonOne\Client\Model\AnalyticsDataPointWithTrend|null $totalDiscounts The total value of discounts given for cart items in influenced sessions.
     *
     * @return self
     */
     ...
     * Sets couponsCount
     *
     * @param \TalonOne\Client\Model\AnalyticsDataPointWithTrend|null $couponsCount The number of times a coupon was successfully redeemed in influenced sessions.
     *
     * @return self
     */
