...
/**
 * AudienceReference Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class AudienceReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudienceReference';
    ...
    */
    ...
    public function setIntegrationId($integrationId)
    {
        ...
        if ((mb_strlen($integrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling AudienceReference., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($integrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling AudienceReference., must be bigger than or equal to 1.');
        }
     ...
     * Sets integration
     *
     * @param string|null $integration The third-party integration of the audience.
     *
     * @return self
     */
