 ...
 */
class BulkOperationOnCampaigns implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OPERATION_ACTIVATE_REVISION = 'activate_revision';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['campaignIds']) > 50)) {
            $invalidProperties[] = "invalid value for 'campaignIds', number of items must be less than or equal to 50.";
        }
    ...
    public function setCampaignIds($campaignIds)
    {
        ...
        if ((count($campaignIds) > 50)) {
            throw new \InvalidArgumentException('invalid value for $campaignIds when calling BulkOperationOnCampaigns., number of items must be less than or equal to 50.');
        }
