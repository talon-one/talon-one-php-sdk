 ...
 */
class LoyaltySubLedger implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('expiringPoints', $data ?? [], null);
        $this->setIfExists('activePoints', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($expiringPoints)) {
            throw new \InvalidArgumentException('non-nullable expiringPoints cannot be null');
        }
    ...
    {
        if (is_null($activePoints)) {
            throw new \InvalidArgumentException('non-nullable activePoints cannot be null');
        }
    ...
    public function setExpiredPoints($expiredPoints)
    {
        if (is_null($expiredPoints)) {
            throw new \InvalidArgumentException('non-nullable expiredPoints cannot be null');
        }
