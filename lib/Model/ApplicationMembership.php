...
/**
 * ApplicationMembership Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationMembership implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ApplicationMembership';
     ...
     * Sets applicationId
     *
     * @param int $applicationId The ID of the Application the customer belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string $applicationName The name of the Application the customer belongs to.
     *
     * @return self
     */
