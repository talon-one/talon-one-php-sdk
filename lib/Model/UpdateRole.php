 ...
 */
class UpdateRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets acl
     *
     * @param string|null $acl The `Access Control List` json defining the role of the user. This represents the access control on the user level.
     *
     * @return self
     */
