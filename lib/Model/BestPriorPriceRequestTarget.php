...
/**
 * BestPriorPriceRequestTarget Class Doc Comment
 *
 * @category Class
 ...
 */
class BestPriorPriceRequestTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BestPriorPriceRequest_target';
    ...
    public const TARGET_TYPE_AUDIENCE = 'AUDIENCE';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['targetType']) && !in_array($this->container['targetType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'targetType', must be one of '%s'",
                $this->container['targetType'],
     ...
     * Sets targetType
     *
     * @param string $targetType The type of price target.
     *
     * @return self
     */
     ...
     * Sets audienceID
     *
     * @param int|null $audienceID The AudienceID of an audience. Must be used with \"AUDIENCE\" target type.
     *
     * @return self
     */
