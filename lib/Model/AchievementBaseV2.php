...
/**
 * AchievementBaseV2 Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class AchievementBaseV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AchievementBaseV2';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AchievementBaseV2., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AchievementBaseV2., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z]\\w+$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling AchievementBaseV2., must conform to the pattern /^[a-zA-Z]\\w+$/.");
        }
    ...
    public function setSubscribedApplications($subscribedApplications)
    {
        ...
        if ((count($subscribedApplications) < 0)) {
            throw new \InvalidArgumentException('invalid length for $subscribedApplications when calling AchievementBaseV2., number of items must be greater than or equal to 0.');
        }
