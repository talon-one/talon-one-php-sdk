...
/**
 * PassthroughBlock Class Doc Comment
 *
 * @category Class
 ...
 */
class PassthroughBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PassthroughBlock';
     ...
     * Sets type
     *
     * @param string $type The type discriminator for this block.
     *
     * @return self
     */
     ...
     * Sets expression
     *
     * @param mixed[] $expression The raw Talang expression as an array. The first element is the function name; subsequent elements are its arguments, which may themselves be nested expressions.
     *
     * @return self
     */
