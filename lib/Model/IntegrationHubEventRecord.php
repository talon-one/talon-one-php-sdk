...
class IntegrationHubEventRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['eventData'] === null && !$this->isNullableSetToNull('eventData')) {
            $invalidProperties[] = "'eventData' is required";
        }
     ...
     * Sets eventData
     *
     * @param mixed|null $eventData eventData
     *
     * @return self
     */
    public function setEventData($eventData)
    {
        if (is_null($eventData)) {
            array_push($this->openAPINullablesSetToNull, 'eventData');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('eventData', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($processAfter)) {
            throw new \InvalidArgumentException('non-nullable processAfter cannot be null');
        }
