...
/**
 * AddLoyaltyPointsSupport Class Doc Comment
 *
 * @category Class
 ...
 */
class AddLoyaltyPointsSupport implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AddLoyaltyPointsSupport';
    ...
    public function setPoints($points)
    {
        ...
        if (($points > 999999999999.99)) {
            throw new \InvalidArgumentException('invalid value for $points when calling AddLoyaltyPointsSupport., must be smaller than or equal to 999999999999.99.');
        }
        if (($points <= 0)) {
            throw new \InvalidArgumentException('invalid value for $points when calling AddLoyaltyPointsSupport., must be bigger than 0.');
        }
     ...
     *
     * @param int|null $supportRequestId ID of the support request to approve. When provided by an admin, the points are added on behalf of the support user who created the request.
     *
     * @return self
     */
     ...
     * Sets processingNote
     *
     * @param string|null $processingNote Note from the admin approving the support request. Stored as the processing note on the support request record. This is only used when a supportRequestId is passed.
     *
     * @return self
     */
