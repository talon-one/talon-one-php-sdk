...
class ChangeLoyaltyTierLevelEffectProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets programId
     *
     * @param int $programId The ID of the loyalty program where the points were added.
     *
     * @return self
     */
     ...
     * Sets subLedgerId
     *
     * @param string $subLedgerId The ID of the subledger within the loyalty program where the points were added.
     *
     * @return self
     */
