...
/**
 * RewardPointsRequired Class Doc Comment
 *
 * @category Class
 ...
 */
class RewardPointsRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RewardPointsRequired';
     ...
     * Sets id
     *
     * @param int|null $id The ID of the `pointsRequired` entry. When updating a reward, include this property to update an existing entry. Omit it to create a new one.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount The number of loyalty points required to activate the reward.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling RewardPointsRequired., must be bigger than or equal to 0.');
        }
     ...
     * Sets subledgerId
     *
     * @param string $subledgerId The ID of the subledger within the loyalty program from which points are deducted when activating the reward.  To specify the main ledger, provide an empty string (\"\").
     *
     * @return self
     */
