...
class Application implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (is_null($defaultEvaluationGroupId)) {
            throw new \InvalidArgumentException('non-nullable defaultEvaluationGroupId cannot be null');
        }
    ...
    {
        if (is_null($defaultCartItemFilterId)) {
            throw new \InvalidArgumentException('non-nullable defaultCartItemFilterId cannot be null');
        }
