...
/**
 * ExpiringPointsNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExpiringPointsNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpiringPointsNotification';
    ...
    protected static $openAPITypes = [
        'totalResultSize' => 'int',
        'data' => '\TalonOne\Client\Model\ExpiringPointsData[]',
    ...
    public const NOTIFICATION_TYPE_LOYALTY_POINTS_EXPIRING = 'LoyaltyPointsExpiring';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_LOYALTY_POINTS_EXPIRING,
        ];
    }
    ...
    */
     ...
     * Gets data
     *
     * @return \TalonOne\Client\Model\ExpiringPointsData[]
     */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\ExpiringPointsData[] $data The array of expiring points.
     *
     * @return self
     */
