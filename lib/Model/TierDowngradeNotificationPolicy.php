...
/**
 * TierDowngradeNotificationPolicy Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class TierDowngradeNotificationPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TierDowngradeNotificationPolicy';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TierDowngradeNotificationPolicy., must be bigger than or equal to 1.');
        }
