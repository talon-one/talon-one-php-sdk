 ...
 */
class TierWillDowngradeData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (is_null($pointsRequiredToRemain)) {
            throw new \InvalidArgumentException('non-nullable pointsRequiredToRemain cannot be null');
        }
