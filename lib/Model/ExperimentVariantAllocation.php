...
/**
 * ExperimentVariantAllocation Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentVariantAllocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentVariantAllocation';
    ...
    */
     ...
     * Sets experimentID
     *
     * @param int $experimentID The ID of the experiment.
     *
     * @return self
     */
     ...
     * Sets variantID
     *
     * @param int $variantID The ID of the variant to be allocated.
     *
     * @return self
     */
