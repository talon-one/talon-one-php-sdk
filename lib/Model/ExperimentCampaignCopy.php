...
/**
 * ExperimentCampaignCopy Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentCampaignCopy implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExperimentCampaignCopy';
    ...
    public function setTags($tags)
    {
        ...
        if ((count($tags) > 50)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling ExperimentCampaignCopy., number of items must be less than or equal to 50.');
        }
