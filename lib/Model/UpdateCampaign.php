 ...
 */
class UpdateCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTags($tags)
    {
        ...
        if ((count($tags) > 50)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling UpdateCampaign., number of items must be less than or equal to 50.');
        }
