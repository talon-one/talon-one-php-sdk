...
/**
 * ProductUnitAnalyticsDataPoint Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductUnitAnalyticsDataPoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductUnitAnalyticsDataPoint';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unitsSold', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unitsSold'] === null) {
            $invalidProperties[] = "'unitsSold' can't be null";
        }
     ...
     * Sets unitsSold
     *
     * @param \TalonOne\Client\Model\AnalyticsDataPointWithTrend $unitsSold The number of times the product or SKU was purchased.
     *
     * @return self
     */
    public function setUnitsSold($unitsSold)
    {
        if (is_null($unitsSold)) {
            throw new \InvalidArgumentException('non-nullable unitsSold cannot be null');
        }
