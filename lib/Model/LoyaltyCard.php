...
class LoyaltyCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $oldCardIdentifier The identifier of the card from which the points were transferred.
     *
     * @return self
     */
     ...
     *
     * @param string|null $newCardIdentifier The identifier of the card to which the points were transferred.
     *
     * @return self
     */
