...
/**
 * UpdateAchievementProgressBlock Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAchievementProgressBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateAchievementProgressBlock';
     ...
     * Sets value
     *
     * @param string $value The value to update the progress by. Supports template placeholders (e.g. \"{{$Session.Total / 2}}\") for dynamic quantities.
     *
     * @return self
     */
