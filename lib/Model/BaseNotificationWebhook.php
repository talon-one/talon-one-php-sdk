...
/**
 * BaseNotificationWebhook Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class BaseNotificationWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseNotificationWebhook';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url API URL for the given webhook-based notification.
     *
     * @return self
     */
     ...
     * Sets headers
     *
     * @param string[] $headers List of API HTTP headers for the given webhook-based notification.
     *
     * @return self
     */
