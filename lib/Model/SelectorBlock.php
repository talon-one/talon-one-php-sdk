...
/**
 * SelectorBlock Class Doc Comment
 *
 * @category Class
 * @description A predicate block valid inside a selector filter step. The &#x60;type&#x60; field determines the block variant.
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SelectorBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SelectorBlock';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'operator' => 'string',
        'blocks' => '\TalonOne\Client\Model\SelectorBlock[]',
        'expression' => 'mixed[]'
    ];
     ...
     * Sets blocks
     *
     * @param \TalonOne\Client\Model\SelectorBlock[] $blocks Child predicate blocks evaluated according to the operator.
     *
     * @return self
     */
