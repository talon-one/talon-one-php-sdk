...
/**
 * AddFreeItemEffectProps Class Doc Comment
 *
 * @category Class
 ...
 */
class AddFreeItemEffectProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AddFreeItemEffectProps';
     ...
     * Sets name
     *
     * @param string $name Description of the effect.
     *
     * @return self
     */
