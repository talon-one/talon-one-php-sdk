...
/**
 * SortSelectorStepField Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class SortSelectorStepField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SortSelectorStepField';
     ...
     * Sets expression
     *
     * @param string $expression The attribute path the items are sorted by.
     *
     * @return self
     */
     ...
     * Sets direction
     *
     * @param string $direction The sort direction for this field.
     *
     * @return self
     */
