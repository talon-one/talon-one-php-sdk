...
/**
 * StrikethroughGroupBlock Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class StrikethroughGroupBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'StrikethroughGroupBlock';
     ...
     * Sets operator
     *
     * @param string $operator Logical operator applied across child blocks. `all` requires every child to pass, `atLeastOne` requires at least one, `none` requires all to fail.
     *
     * @return self
     */
