...
/**
 * CustomerAchievement Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerAchievement implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CustomerAchievement';
     ...
     * Sets id
     *
     * @param int $id The internal ID of the achievement.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomerAchievement., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomerAchievement., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z]\\w+$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CustomerAchievement., must conform to the pattern /^[a-zA-Z]\\w+$/.");
        }
     ...
     * Sets fixedStartDate
     *
     * @param \DateTime|null $fixedStartDate The achievement's start date when `activationPolicy` is equal to `fixed_schedule`.  **Note:** It is an RFC3339 timestamp string.
     *
     * @return self
     */
     ...
     * Sets endDate
     *
     * @param \DateTime|null $endDate The achievement's end date. If defined, customers cannot participate in the achievement after this date.  **Note:** It is an RFC3339 timestamp string.
     *
     * @return self
     */
     ...
     *
     * @param bool $allowRollbackAfterCompletion When `true`, customer progress can be rolled back in completed achievements.
     *
     * @return self
     */
     ...
     *
     * @param \TalonOne\Client\Model\AchievementProgress|null $currentProgress currentProgress
     *
     * @return self
     */
