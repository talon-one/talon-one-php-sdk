...
/**
 * CouponEligibilityInfo Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CouponEligibilityInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CouponEligibilityInfo';
     ...
     * Sets campaignId
     *
     * @param int $campaignId The ID of the campaign that owns the coupon.
     *
     * @return self
     */
     ...
     * Sets failureReason
     *
     * @param string|null $failureReason The reason the coupon is not eligible, if applicable.
     *
     * @return self
     */
