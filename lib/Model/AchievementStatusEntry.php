...
/**
 * AchievementStatusEntry Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class AchievementStatusEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AchievementStatusEntry';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AchievementStatusEntry., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AchievementStatusEntry., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z]\\w+$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling AchievementStatusEntry., must conform to the pattern /^[a-zA-Z]\\w+$/.");
        }
