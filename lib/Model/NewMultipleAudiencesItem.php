...
/**
 * NewMultipleAudiencesItem Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewMultipleAudiencesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NewMultipleAudiencesItem';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NewMultipleAudiencesItem., must be bigger than or equal to 1.');
        }
    ...
    public function setIntegrationId($integrationId)
    {
        ...
        if ((mb_strlen($integrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling NewMultipleAudiencesItem., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($integrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling NewMultipleAudiencesItem., must be bigger than or equal to 1.');
        }
