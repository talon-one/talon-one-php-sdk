 ...
 */
class TriggerWebhookBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets params
     *
     * @param array<string,mixed>|null $params The webhook's parameters, in configured order. Each property name is the parameter's title, lowercased with spaces replaced by underscores (for example, `Order ID` becomes `order_id`); falls back to `param_0`, `param_1`, and so on if a title is blank or collides with another.
     *
     * @return self
     */
