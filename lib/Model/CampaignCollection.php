...
class CampaignCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payload']) && (count($this->container['payload']) > 50)) {
            $invalidProperties[] = "invalid value for 'payload', number of items must be less than or equal to 50.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CampaignCollection., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[^[:cntrl:]\\s][^[:cntrl:]]*$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CampaignCollection., must conform to the pattern /^[^[:cntrl:]\\s][^[:cntrl:]]*$/.");
        }
    ...
    public function setPayload($payload)
    {
        ...
        if ((count($payload) > 50)) {
            throw new \InvalidArgumentException('invalid value for $payload when calling CampaignCollection., number of items must be less than or equal to 50.');
        }
