...
/**
 * BulkApplicationNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkApplicationNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkApplicationNotification';
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\CampaignEvaluationTreeChangedNotification[] $data data
     *
     * @return self
     */
