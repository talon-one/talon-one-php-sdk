 ...
 */
class CreateApplicationAPIKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PLATFORM_SEGMENT = 'segment';
    public const PLATFORM_BRAZE = 'braze';
    public const PLATFORM_MPARTICLE = 'mparticle';
    public const PLATFORM_SHOPIFY = 'shopify';
    public const PLATFORM_ITERABLE = 'iterable';
    public const PLATFORM_CUSTOMER_ENGAGEMENT = 'customer_engagement';
    public const PLATFORM_CUSTOMER_DATA = 'customer_data';
    public const PLATFORM_SALESFORCE = 'salesforce';
    public const PLATFORM_EMARSYS = 'emarsys';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('timeOffset', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTimeOffset($timeOffset)
    {
        if (is_null($timeOffset)) {
            throw new \InvalidArgumentException('non-nullable timeOffset cannot be null');
        }
