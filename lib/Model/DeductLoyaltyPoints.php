...
/**
 * DeductLoyaltyPoints Class Doc Comment
 *
 * @category Class
 ...
 */
class DeductLoyaltyPoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeductLoyaltyPoints';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name / reason for the point deduction.
     *
     * @return self
     */
     ...
     * Sets subledgerId
     *
     * @param string|null $subledgerId ID of the subledger the points are deducted from.
     *
     * @return self
     */
     ...
     * Sets applicationId
     *
     * @param int|null $applicationId ID of the Application that is connected to the loyalty program.
     *
     * @return self
     */
