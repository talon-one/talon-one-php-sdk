...
/**
 * LoyaltyCardRegistration Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoyaltyCardRegistration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltyCardRegistration';
    ...
    */
     ...
     * Sets integrationId
     *
     * @param string $integrationId The integrationId of the customer profile.
     *
     * @return self
     */
