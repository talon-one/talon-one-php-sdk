...
/**
 * SamlConnectionInternal Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class SamlConnectionInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SamlConnectionInternal';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('metadataDocument', $data ?? [], null);
    }
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SamlConnectionInternal., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($metadataDocument)) {
            throw new \InvalidArgumentException('non-nullable metadataDocument cannot be null');
        }

        if ((mb_strlen($metadataDocument) < 1)) {
            throw new \InvalidArgumentException('invalid length for $metadataDocument when calling SamlConnectionInternal., must be bigger than or equal to 1.');
        }
