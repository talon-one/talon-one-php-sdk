...
/**
 * BaseNotificationPolicy Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseNotificationPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BaseNotificationPolicy';
    ...
    public const SCOPES_ALL = 'all';
    public const SCOPES_CAMPAIGN_MANAGER = 'campaign_manager';
    public const SCOPES_MANAGEMENT_API = 'management_api';
    public const SCOPES_RULE_ENGINE = 'rule_engine';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('includeData', $data ?? [], null);
        $this->setIfExists('aheadOfDaysTrigger', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['triggers']) > 3)) {
            $invalidProperties[] = "invalid value for 'triggers', number of items must be less than or equal to 3.";
        }
        ...
        if ((count($this->container['scopes']) > 4)) {
            $invalidProperties[] = "invalid value for 'scopes', number of items must be less than or equal to 4.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BaseNotificationPolicy., must be bigger than or equal to 1.');
        }
     ...
     * Gets triggers
     *
     * @return \TalonOne\Client\Model\TierWillDowngradeNotificationTrigger[]
     */
     ...
     * Sets triggers
     *
     * @param \TalonOne\Client\Model\TierWillDowngradeNotificationTrigger[] $triggers triggers
     *
     * @return self
     */
    public function setTriggers($triggers)
    {
        ...
        if ((count($triggers) > 3)) {
            throw new \InvalidArgumentException('invalid value for $triggers when calling BaseNotificationPolicy., number of items must be less than or equal to 3.');
        }
        if ((count($triggers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $triggers when calling BaseNotificationPolicy., number of items must be greater than or equal to 1.');
        }
    ...
    public function setScopes($scopes)
    {
        ...
        if ((count($scopes) > 4)) {
            throw new \InvalidArgumentException('invalid value for $scopes when calling BaseNotificationPolicy., number of items must be less than or equal to 4.');
        }
        if ((count($scopes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scopes when calling BaseNotificationPolicy., number of items must be greater than or equal to 1.');
        }
    ...
    {
        if (is_null($includeData)) {
            throw new \InvalidArgumentException('non-nullable includeData cannot be null');
        }
    ...
    {
        if (is_null($aheadOfDaysTrigger)) {
            throw new \InvalidArgumentException('non-nullable aheadOfDaysTrigger cannot be null');
        }
        if (($aheadOfDaysTrigger > 30)) {
            throw new \InvalidArgumentException('invalid value for $aheadOfDaysTrigger when calling BaseNotificationPolicy., must be smaller than or equal to 30.');
        }
        if (($aheadOfDaysTrigger < 1)) {
            throw new \InvalidArgumentException('invalid value for $aheadOfDaysTrigger when calling BaseNotificationPolicy., must be bigger than or equal to 1.');
        }
