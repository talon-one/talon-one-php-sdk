...
/**
 * InfluencingCampaignDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class InfluencingCampaignDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InfluencingCampaignDetails';
    ...
    */
     ...
     * Sets campaignId
     *
     * @param int $campaignId Identifier of the campaign that influenced the final price.
     *
     * @return self
     */
     ...
     * Sets discountValue
     *
     * @param float $discountValue Discount value applied by the campaign.
     *
     * @return self
     */
    public function setDiscountValue($discountValue)
    {
        if (is_null($discountValue)) {
            throw new \InvalidArgumentException('non-nullable discountValue cannot be null');
        }
