...
/**
 * CampaignStoreBudgetLimitConfig Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignStoreBudgetLimitConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignStoreBudgetLimitConfig';
    ...
    */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling CampaignStoreBudgetLimitConfig., must be bigger than or equal to 0.');
        }
     ...
     * Sets imported
     *
     * @param bool $imported Indicates whether this limit configuration is managed via a CSV file.
     *
     * @return self
     */
