...
class CustomerProfileIntegrationRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param mixed|null $audiencesChanges Audiences memberships changes for this profile.
     *
     * @return self
     */
    public function setAudiencesChanges($audiencesChanges)
    {
        if (is_null($audiencesChanges)) {
            array_push($this->openAPINullablesSetToNull, 'audiencesChanges');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('audiencesChanges', $nullablesSetToNull);
            if ($index !== FALSE) {
