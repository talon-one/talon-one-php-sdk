...
/**
 * CampaignEvaluationGroup Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignEvaluationGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignEvaluationGroup';
    ...
    */
    ...
    public function setParentId($parentId)
    {
        ...
        if (($parentId < 1)) {
            throw new \InvalidArgumentException('invalid value for $parentId when calling CampaignEvaluationGroup., must be bigger than or equal to 1.');
        }
