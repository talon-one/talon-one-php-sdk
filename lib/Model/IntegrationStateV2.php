...
class IntegrationStateV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('campaignEligibility', $data ?? [], null);
    ...
    {
        if (is_null($campaignEligibility)) {
            throw new \InvalidArgumentException('non-nullable campaignEligibility cannot be null');
        }
     ...
     * Sets rewards
     *
     * @param \TalonOne\Client\Model\RewardWithUnlocks[]|null $rewards The unlocked rewards for the customer profile.
     *
     * @return self
     */
     ...
     * Sets coupons
     *
     * @param \TalonOne\Client\Model\IntegrationCoupon[]|null $coupons The coupons that were processed.
     *
     * @return self
     */
     ...
     * Sets event
     *
     * @param \TalonOne\Client\Model\Event|null $event The event that was processed.
     *
     * @return self
     */
     ...
     *
     * @param \TalonOne\Client\Model\CustomerSessionV2|null $customerSession The session that was processed.
     *
     * @return self
     */
     ...
     * Sets return
     *
     * @param \TalonOne\Client\Model\ModelReturn|null $return The return that was processed.
     *
     * @return self
     */
     ...
     *
     * @param \TalonOne\Client\Model\ModelReturn[]|null $previousReturns The previous returns associated with the event.
     *
     * @return self
     */
