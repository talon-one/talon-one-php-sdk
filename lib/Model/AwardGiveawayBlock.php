...
class AwardGiveawayBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets onFailure
     *
     * @param mixed[]|null $onFailure Blocks evaluated when this block fails or returns false.
     *
     * @return self
     */
     ...
     * Sets onError
     *
     * @param array<string,mixed[]>|null $onError Named error handlers evaluated when a specific error occurs.
     *
     * @return self
     */
