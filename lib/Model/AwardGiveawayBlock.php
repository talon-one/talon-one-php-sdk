...
/**
 * AwardGiveawayBlock Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class AwardGiveawayBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AwardGiveawayBlock';
     ...
     * Sets profile
     *
     * @param string $profile The customer profile to award the giveaway to. `Current` targets the customer in the current session; `Advocate` targets the person who invited their friend via referral program.
     *
     * @return self
     */
     ...
     * Sets onFailure
     *
     * @param \TalonOne\Client\Model\Block[]|null $onFailure Blocks evaluated when this block fails or returns false.
     *
     * @return self
     */
