 ...
 */
class IntegrationHubFlowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('disabledUntil', $data ?? [], null);
    ...
    {
        if (is_null($disabledUntil)) {
            array_push($this->openAPINullablesSetToNull, 'disabledUntil');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('disabledUntil', $nullablesSetToNull);
            if ($index !== FALSE) {
