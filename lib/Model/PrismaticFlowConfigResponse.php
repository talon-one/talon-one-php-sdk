...
/**
 * PrismaticFlowConfigResponse Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class PrismaticFlowConfigResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrismaticFlowConfigResponse';
    ...
    */
    ...
    public function setWorkerCount($workerCount)
    {
        ...
        if (($workerCount > 500)) {
            throw new \InvalidArgumentException('invalid value for $workerCount when calling PrismaticFlowConfigResponse., must be smaller than or equal to 500.');
        }
        if (($workerCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $workerCount when calling PrismaticFlowConfigResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxEventsPerMessage($maxEventsPerMessage)
    {
        ...
        if (($maxEventsPerMessage < 1)) {
            throw new \InvalidArgumentException('invalid value for $maxEventsPerMessage when calling PrismaticFlowConfigResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxRetries($maxRetries)
    {
        ...
        if (($maxRetries < 0)) {
            throw new \InvalidArgumentException('invalid value for $maxRetries when calling PrismaticFlowConfigResponse., must be bigger than or equal to 0.');
        }
