...
/**
 * EffectAllOfProps Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class EffectAllOfProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Effect_allOf_props';
    ...
    public function setRecipientIntegrationId($recipientIntegrationId)
    {
        ...
        if ((mb_strlen($recipientIntegrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $recipientIntegrationId when calling EffectAllOfProps., must be smaller than or equal to 1000.');
        }
    ...
    public function setCardIdentifier($cardIdentifier)
    {
        ...
        if ((mb_strlen($cardIdentifier) > 108)) {
            throw new \InvalidArgumentException('invalid length for $cardIdentifier when calling EffectAllOfProps., must be smaller than or equal to 108.');
        }
        if ((mb_strlen($cardIdentifier) < 4)) {
            throw new \InvalidArgumentException('invalid length for $cardIdentifier when calling EffectAllOfProps., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^[A-Za-z0-9._%+@-]+$/", ObjectSerializer::toString($cardIdentifier)))) {
            throw new \InvalidArgumentException("invalid value for \$cardIdentifier when calling EffectAllOfProps., must conform to the pattern /^[A-Za-z0-9._%+@-]+$/.");
        }
