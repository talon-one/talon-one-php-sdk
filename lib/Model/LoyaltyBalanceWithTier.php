 ...
 */
class LoyaltyBalanceWithTier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('negativePoints', $data ?? [], null);
        $this->setIfExists('currentTier', $data ?? [], null);
        $this->setIfExists('projectedTier', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($negativePoints)) {
            throw new \InvalidArgumentException('non-nullable negativePoints cannot be null');
        }
     ...
     * Sets currentTier
     *
     * @param \TalonOne\Client\Model\Tier|null $currentTier Customer's current tier.
     *
     * @return self
     */
    ...
    {
        if (is_null($projectedTier)) {
            throw new \InvalidArgumentException('non-nullable projectedTier cannot be null');
        }
