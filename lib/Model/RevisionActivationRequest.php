 ...
 */
class RevisionActivationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setUserIds($userIds)
    {
        ...
        if ((count($userIds) > 5)) {
            throw new \InvalidArgumentException('invalid value for $userIds when calling RevisionActivationRequest., number of items must be less than or equal to 5.');
        }
