 ...
 */
class NewStore implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewStore';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NewStore., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NewStore., must be bigger than or equal to 1.');
        }
    ...
    public function setIntegrationId($integrationId)
    {
        ...
        if ((mb_strlen($integrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling NewStore., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($integrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $integrationId when calling NewStore., must be bigger than or equal to 1.');
        }
