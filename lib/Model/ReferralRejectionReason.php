 ...
 */
class ReferralRejectionReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const REASON_REFERRAL_NOT_FOUND = 'ReferralNotFound';
    public const REASON_REFERRAL_RECIPIENT_ID_SAME_AS_ADVOCATE = 'ReferralRecipientIdSameAsAdvocate';
    public const REASON_REFERRAL_PART_OF_NOT_RUNNING_CAMPAIGN = 'ReferralPartOfNotRunningCampaign';
    public const REASON_REFERRAL_LIMIT_REACHED = 'ReferralLimitReached';
    ...
    public const REASON_REFERRAL_RECIPIENT_DOES_NOT_MATCH = 'ReferralRecipientDoesNotMatch';
    public const REASON_REFERRAL_EXPIRED = 'ReferralExpired';
    public const REASON_REFERRAL_START_DATE_IN_FUTURE = 'ReferralStartDateInFuture';
    public const REASON_REFERRAL_REJECTED_BY_CONDITION = 'ReferralRejectedByCondition';
    public const REASON_EFFECT_COULD_NOT_BE_APPLIED = 'EffectCouldNotBeApplied';
    public const REASON_REFERRAL_PART_OF_NOT_TRIGGERED_CAMPAIGN = 'ReferralPartOfNotTriggeredCampaign';
