...
/**
 * MultiApplicationEntity Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class MultiApplicationEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultiApplicationEntity';
    ...
    */
    ...
    public function setApplicationIds($applicationIds)
    {
        ...
        if ((count($applicationIds) < 1)) {
            throw new \InvalidArgumentException('invalid length for $applicationIds when calling MultiApplicationEntity., number of items must be greater than or equal to 1.');
        }
