 ...
 */
class InventoryCoupon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('profileRedemptionCount', $data ?? [], null);
    ...
    */
    ...
    public function setDiscountLimit($discountLimit)
    {
        ...
        if (($discountLimit > 1000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $discountLimit when calling InventoryCoupon., must be smaller than or equal to 1000000000000000.');
        }
        if (($discountLimit < 0)) {
    ...
    public function setReservationLimit($reservationLimit)
    {
        ...
        if (($reservationLimit > 999999)) {
            throw new \InvalidArgumentException('invalid value for $reservationLimit when calling InventoryCoupon., must be smaller than or equal to 999999.');
        }
        if (($reservationLimit < 0)) {
            throw new \InvalidArgumentException('invalid value for $reservationLimit when calling InventoryCoupon., must be bigger than or equal to 0.');
        }
    ...
    {
        if (is_null($profileRedemptionCount)) {
            throw new \InvalidArgumentException('non-nullable profileRedemptionCount cannot be null');
        }
