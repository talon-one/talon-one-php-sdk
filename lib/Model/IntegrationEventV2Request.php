...
/**
 * IntegrationEventV2Request Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationEventV2Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationEventV2Request';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling IntegrationEventV2Request., must be bigger than or equal to 1.');
        }
