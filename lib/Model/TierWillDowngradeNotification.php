...
/**
 * TierWillDowngradeNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class TierWillDowngradeNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TierWillDowngradeNotification';
    ...
    protected static $openAPITypes = [
        'totalResultSize' => 'int',
        'data' => '\TalonOne\Client\Model\TierWillDowngradeData[]',
    ...
    public const NOTIFICATION_TYPE_TIER_WILL_DOWNGRADE = 'TierWillDowngrade';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_TIER_WILL_DOWNGRADE,
        ];
    }
    ...
    */
     ...
     * Gets data
     *
     * @return \TalonOne\Client\Model\TierWillDowngradeData[]
     */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\TierWillDowngradeData[] $data The array of upcoming tier downgrade notifications.
     *
     * @return self
     */
