 ...
 */
class ApplicationApiHealth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SUMMARY_OK = 'OK';
    public const SUMMARY_WARNING = 'WARNING';
    public const SUMMARY_ERROR = 'ERROR';
    public const SUMMARY_CRITICAL = 'CRITICAL';
