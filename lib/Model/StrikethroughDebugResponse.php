 ...
 */
class StrikethroughDebugResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('campaignsIDs', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($campaignsIDs)) {
            throw new \InvalidArgumentException('non-nullable campaignsIDs cannot be null');
        }
