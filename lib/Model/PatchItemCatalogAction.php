 ...
 */
class PatchItemCatalogAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchItemCatalogAction';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('createIfNotExists', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets sku
     *
     * @param string $sku The unique SKU of the item to patch.
     *
     * @return self
     */
     ...
     * Sets attributes
     *
     * @param object|null $attributes The attributes of the item to patch.
     *
     * @return self
     */
    ...
    /**
     * Gets createIfNotExists
     *
     * @return bool|null
     */
    public function getCreateIfNotExists()
    {
        return $this->container['createIfNotExists'];
    }

    /**
     * Sets createIfNotExists
     *
     * @param bool|null $createIfNotExists Indicates whether to create an item if the SKU does not exist.
     *
     * @return self
     */
    public function setCreateIfNotExists($createIfNotExists)
    {
        if (is_null($createIfNotExists)) {
            throw new \InvalidArgumentException('non-nullable createIfNotExists cannot be null');
        }
        $this->container['createIfNotExists'] = $createIfNotExists;
