 ...
 */
class DeleteCouponsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const NOTIFICATION_TYPE_COUPONS_DELETED = 'CouponsDeleted';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_COUPONS_DELETED,
        ];
    }
