...
/**
 * EventV3ReferralEntity Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventV3ReferralEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EventV3ReferralEntity';
    ...
    public function setReferralCode($referralCode)
    {
        ...
        if ((mb_strlen($referralCode) > 100)) {
            throw new \InvalidArgumentException('invalid length for $referralCode when calling EventV3ReferralEntity., must be smaller than or equal to 100.');
        }
