 ...
 */
class LoyaltyProgram implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'canUpdateJoinPolicy' => false,
        'canUpdateTierExpirationPolicy' => false,
        'canUpgradeToAdvancedTiers' => false,
        'canUpdateSubledgers' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cardBased', $data ?? [], false);
        $this->setIfExists('canUpdateTiers', $data ?? [], false);
        $this->setIfExists('canUpdateJoinPolicy', $data ?? [], null);
        $this->setIfExists('canUpdateTierExpirationPolicy', $data ?? [], null);
        $this->setIfExists('canUpgradeToAdvancedTiers', $data ?? [], false);
        $this->setIfExists('canUpdateSubledgers', $data ?? [], false);
    }
    ...
    */
    ...
    {
        if (is_null($cardBased)) {
            throw new \InvalidArgumentException('non-nullable cardBased cannot be null');
        }
    ...
    {
        if (is_null($canUpdateTiers)) {
            throw new \InvalidArgumentException('non-nullable canUpdateTiers cannot be null');
        }
    ...
    {
        if (is_null($canUpdateJoinPolicy)) {
            throw new \InvalidArgumentException('non-nullable canUpdateJoinPolicy cannot be null');
        }
    ...
    {
        if (is_null($canUpdateTierExpirationPolicy)) {
            throw new \InvalidArgumentException('non-nullable canUpdateTierExpirationPolicy cannot be null');
        }
    ...
    {
        if (is_null($canUpgradeToAdvancedTiers)) {
            throw new \InvalidArgumentException('non-nullable canUpgradeToAdvancedTiers cannot be null');
        }
    ...
    {
        if (is_null($canUpdateSubledgers)) {
            throw new \InvalidArgumentException('non-nullable canUpdateSubledgers cannot be null');
        }
