...
class CampaignEditedNotificationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets oldCampaign
     *
     * @param \TalonOne\Client\Model\Campaign $oldCampaign The campaign before the change.
     *
     * @return self
     */
    public function setOldCampaign($oldCampaign)
    {
        if (is_null($oldCampaign)) {
            throw new \InvalidArgumentException('non-nullable oldCampaign cannot be null');
        }
