...
/**
 * RewardCatalogItem Class Doc Comment
 *
 * @category Class
 ...
 */
class RewardCatalogItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RewardCatalogItem';
    ...
    protected static $openAPITypes = [
        ...
        'eligibility' => '\TalonOne\Client\Model\RewardEligibility'
    ];
     ...
     * Sets pointsRequired
     *
     * @param \TalonOne\Client\Model\RewardPointsRequired[]|null $pointsRequired The loyalty points required to activate the reward.
     *
     * @return self
     */
     ...
     * Gets eligibility
     *
     * @return \TalonOne\Client\Model\RewardEligibility|null
     */
     ...
     * Sets eligibility
     *
     * @param \TalonOne\Client\Model\RewardEligibility|null $eligibility The customer's eligibility for the reward. Returned only when the request includes a `profileIntegrationId` or `loyaltyCardId`.
     *
     * @return self
     */
