...
/**
 * CampaignRulesetChangedNotificationItem Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignRulesetChangedNotificationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignRulesetChangedNotificationItem';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('oldRuleset', $data ?? [], null);
        $this->setIfExists('oldPlaceholders', $data ?? [], null);
    ...
    */
     ...
     * Sets oldRuleset
     *
     * @param \TalonOne\Client\Model\Ruleset|null $oldRuleset The old ruleset, if the ruleset was changed.
     *
     * @return self
     */
    public function setOldRuleset($oldRuleset)
    {
        if (is_null($oldRuleset)) {
            throw new \InvalidArgumentException('non-nullable oldRuleset cannot be null');
        }
    ...
    {
        if (is_null($oldPlaceholders)) {
            throw new \InvalidArgumentException('non-nullable oldPlaceholders cannot be null');
        }
