 ...
 */
class RolesV2Thresholds implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RolesV2Thresholds';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('loyaltyPointsLimit', $data ?? [], null);
    }
     ...
     * @return int|null
     */
    public function getLoyaltyPointsLimit()
    {
        return $this->container['loyaltyPointsLimit'];
    }

    /**
     * Sets loyaltyPointsLimit
     *
     * @param int|null $loyaltyPointsLimit Maximum number of loyalty points a support user can award without approval.
     *
     * @return self
     */
    public function setLoyaltyPointsLimit($loyaltyPointsLimit)
    {
        if (is_null($loyaltyPointsLimit)) {
            throw new \InvalidArgumentException('non-nullable loyaltyPointsLimit cannot be null');
        }
        $this->container['loyaltyPointsLimit'] = $loyaltyPointsLimit;
