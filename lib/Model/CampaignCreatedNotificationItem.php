...
class CampaignCreatedNotificationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \TalonOne\Client\Model\CampaignEvaluationPosition $evaluationPosition The campaign position within the evaluation tree.
     *
     * @return self
     */
    public function setEvaluationPosition($evaluationPosition)
    {
        if (is_null($evaluationPosition)) {
            throw new \InvalidArgumentException('non-nullable evaluationPosition cannot be null');
        }
