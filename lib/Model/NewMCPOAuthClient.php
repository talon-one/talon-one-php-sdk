 ...
 */
class NewMCPOAuthClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setRedirectUris($redirectUris)
    {
        ...
        if ((count($redirectUris) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirectUris when calling NewMCPOAuthClient., number of items must be greater than or equal to 1.');
        }
