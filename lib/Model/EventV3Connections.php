...
/**
 * EventV3Connections Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventV3Connections implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EventV3Connections';
    ...
    public function setConnectedSessionId($connectedSessionId)
    {
        ...
        if ((mb_strlen($connectedSessionId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $connectedSessionId when calling EventV3Connections., must be bigger than or equal to 1.');
        }
