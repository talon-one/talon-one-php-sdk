 ...
 */
class LedgerTransactionLogEntryIntegrationAPI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LedgerTransactionLogEntryIntegrationAPI';
    ...
    */
    ...
    public function setCustomerSessionId($customerSessionId)
    {
        ...
        if ((mb_strlen($customerSessionId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customerSessionId when calling LedgerTransactionLogEntryIntegrationAPI., must be smaller than or equal to 255.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $type when calling LedgerTransactionLogEntryIntegrationAPI., must be smaller than or equal to 255.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling LedgerTransactionLogEntryIntegrationAPI., must be smaller than or equal to 255.');
        }
    ...
    public function setStartDate($startDate)
    {
        ...
        if ((mb_strlen($startDate) > 64)) {
            throw new \InvalidArgumentException('invalid length for $startDate when calling LedgerTransactionLogEntryIntegrationAPI., must be smaller than or equal to 64.');
        }
    ...
    public function setSubledgerId($subledgerId)
    {
        ...
        if ((mb_strlen($subledgerId) > 64)) {
            throw new \InvalidArgumentException('invalid length for $subledgerId when calling LedgerTransactionLogEntryIntegrationAPI., must be smaller than or equal to 64.');
        }
