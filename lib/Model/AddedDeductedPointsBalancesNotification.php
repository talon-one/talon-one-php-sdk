 ...
 */
class AddedDeductedPointsBalancesNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const NOTIFICATION_TYPE_LOYALTY_ADDED_DEDUCTED_POINTS_BALANCES = 'LoyaltyAddedDeductedPointsBalances';
    ...
    */
    ...
    public function setActions($actions)
    {
        ...
        if ((count($actions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $actions when calling AddedDeductedPointsBalancesNotification., number of items must be greater than or equal to 1.');
        }
