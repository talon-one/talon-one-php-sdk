...
/**
 * GiveawayPoolNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class GiveawayPoolNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GiveawayPoolNotification';
    ...
    protected static $openAPITypes = [
        'totalResultSize' => 'int',
        'data' => '\TalonOne\Client\Model\GiveawayPoolNotificationData[]',
    ...
    public const NOTIFICATION_TYPE_GIVEAWAY_POOL_NOTIFICATION = 'GiveawayPoolNotification';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_GIVEAWAY_POOL_NOTIFICATION,
        ];
    }
     ...
     * Gets data
     *
     * @return \TalonOne\Client\Model\GiveawayPoolNotificationData[]
     */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\GiveawayPoolNotificationData[] $data The array of giveaway pool notifications.
     *
     * @return self
     */
