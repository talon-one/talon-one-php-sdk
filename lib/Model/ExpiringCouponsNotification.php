...
/**
 * ExpiringCouponsNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExpiringCouponsNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpiringCouponsNotification';
    ...
    protected static $openAPITypes = [
        'totalResultSize' => 'int',
        'data' => '\TalonOne\Client\Model\ExpiringCouponsData[]',
    ...
    public const NOTIFICATION_TYPE_COUPON_CODE_EXPIRING = 'CouponCodeExpiring';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_COUPON_CODE_EXPIRING,
        ];
    }
    ...
    */
     ...
     * Gets data
     *
     * @return \TalonOne\Client\Model\ExpiringCouponsData[]
     */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\ExpiringCouponsData[] $data The array of expiring coupon notifications.
     *
     * @return self
     */
