...
/**
 * CreateCouponData Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCouponData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCouponData';
    ...
    public const NOTIFICATION_TYPE_COUPON_CREATED = 'CouponCreated';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_COUPON_CREATED,
        ];
    }
    ...
    */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\ExtendedCoupon[]|null $data The array of coupons codes. If 1000 or fewer coupons are requested, all coupon data is sent. If 1001 or more coupons are requested, only `BatchID` is sent.
     *
     * @return self
     */
     ...
     * Sets batchID
     *
     * @param string|null $batchID The ID of the batch to which the coupon belongs.  **Note:** The Batch ID is generated when coupons are created.
     *
     * @return self
     */
     ...
     *
     * @param string $notificationType The type of the not
     *
     * @return self
     */
