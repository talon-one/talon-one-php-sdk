...
/**
 * CheckBudgetBlock Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CheckBudgetBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CheckBudgetBlock';
     ...
     * Sets value
     *
     * @param float|null $value The value to check against when using the `enoughFor` operator.
     *
     * @return self
     */
