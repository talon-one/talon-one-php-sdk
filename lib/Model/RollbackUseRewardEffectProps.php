...
/**
 * RollbackUseRewardEffectProps Class Doc Comment
 *
 * @category Class
 * @description This effect is triggered when a reward usage has been rolled back by a session cancellation.
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RollbackUseRewardEffectProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RollbackUseRewardEffectProps';
     ...
     * Sets integrationId
     *
     * @param string $integrationId The integration ID of the customer reward that was rolled back.
     *
     * @return self
     */
     ...
     * Sets rewardId
     *
     * @param int $rewardId The ID of the reward that was rolled back.
     *
     * @return self
     */
