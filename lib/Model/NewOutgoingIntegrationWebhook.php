...
/**
 * NewOutgoingIntegrationWebhook Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewOutgoingIntegrationWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewOutgoingIntegrationWebhook';
    ...
    */
     ...
     * Sets applicationIds
     *
     * @param int[] $applicationIds IDs of the Applications to which a webhook must be linked.
     *
     * @return self
     */
