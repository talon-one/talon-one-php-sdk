...
/**
 * IntegrationStoreEntity Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationStoreEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationStoreEntity';
    ...
    */
    ...
    public function setStoreIntegrationId($storeIntegrationId)
    {
        ...
        if ((mb_strlen($storeIntegrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $storeIntegrationId when calling IntegrationStoreEntity., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($storeIntegrationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $storeIntegrationId when calling IntegrationStoreEntity., must be bigger than or equal to 1.');
        }
