 ...
 */
class CustomerProfileAudienceRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets audienceId
     *
     * @param int $audienceId The ID of the audience. You get it via the `id` property when [creating an audience](#tag/Audiences/operation/createAudienceV2).
     *
     * @return self
     */
