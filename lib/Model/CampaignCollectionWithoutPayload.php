...
/**
 * CampaignCollectionWithoutPayload Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignCollectionWithoutPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignCollectionWithoutPayload';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CampaignCollectionWithoutPayload., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[^[:cntrl:]\\s][^[:cntrl:]]*$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CampaignCollectionWithoutPayload., must conform to the pattern /^[^[:cntrl:]\\s][^[:cntrl:]]*$/.");
        }
