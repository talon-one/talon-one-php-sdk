...
/**
 * CouponWithApplication Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CouponWithApplication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponWithApplication';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 4)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CouponWithApplication., must be bigger than or equal to 4.');
        }
    ...
    public function setUsageLimit($usageLimit)
    {
        ...
        if (($usageLimit > 999999)) {
            throw new \InvalidArgumentException('invalid value for $usageLimit when calling CouponWithApplication., must be smaller than or equal to 999999.');
        }
        if (($usageLimit < 0)) {
            throw new \InvalidArgumentException('invalid value for $usageLimit when calling CouponWithApplication., must be bigger than or equal to 0.');
        }
    ...
    public function setDiscountLimit($discountLimit)
    {
        ...
        if (($discountLimit > 1000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $discountLimit when calling CouponWithApplication., must be smaller than or equal to 1000000000000000.');
        }
        if (($discountLimit < 0)) {
            throw new \InvalidArgumentException('invalid value for $discountLimit when calling CouponWithApplication., must be bigger than or equal to 0.');
        }
    ...
    public function setReservationLimit($reservationLimit)
    {
        ...
        if (($reservationLimit > 999999)) {
            throw new \InvalidArgumentException('invalid value for $reservationLimit when calling CouponWithApplication., must be smaller than or equal to 999999.');
        }
        if (($reservationLimit < 0)) {
            throw new \InvalidArgumentException('invalid value for $reservationLimit when calling CouponWithApplication., must be bigger than or equal to 0.');
        }
    ...
    public function setRecipientIntegrationId($recipientIntegrationId)
    {
        ...
        if ((mb_strlen($recipientIntegrationId) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $recipientIntegrationId when calling CouponWithApplication., must be smaller than or equal to 1000.');
        }
     ...
     *
     * @param string $applicationName Name of the Application that is connected to the coupon.
     *
     * @return self
     */
