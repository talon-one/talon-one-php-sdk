 ...
 */
class UpdateCouponBatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setDiscountLimit($discountLimit)
    {
        ...
        if (($discountLimit > 1000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $discountLimit when calling UpdateCouponBatch., must be smaller than or equal to 1000000000000000.');
        }
        if (($discountLimit < 0)) {
