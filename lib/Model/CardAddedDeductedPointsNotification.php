...
/**
 * CardAddedDeductedPointsNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CardAddedDeductedPointsNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardAddedDeductedPointsNotification';
    ...
    public const NOTIFICATION_TYPE_LOYALTY_CARD_POINTS_DEDUCTED = 'LoyaltyCardPointsDeducted';
    public const NOTIFICATION_TYPE_LOYALTY_CARD_POINTS_ADDED = 'LoyaltyCardPointsAdded';
