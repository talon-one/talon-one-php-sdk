...
/**
 * CatalogRule Class Doc Comment
 *
 * @category Class
 * @description A rule template stored in a catalog entry. Rules in catalog entries only contain title (no description, as description is at the catalog entry level).
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CatalogRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CatalogRule';
    ...
    */
    ...
    public function setCondition($condition)
    {
        ...
        if ((count($condition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $condition when calling CatalogRule., number of items must be greater than or equal to 1.');
        }
