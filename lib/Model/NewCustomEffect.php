 ...
 */
class NewCustomEffect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setApplicationIds($applicationIds)
    {
        ...
        if ((count($applicationIds) < 1)) {
            throw new \InvalidArgumentException('invalid length for $applicationIds when calling NewCustomEffect., number of items must be greater than or equal to 1.');
        }
