 ...
 */
class ApplicationCIFReferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'applicationCartItemFilterId' => false,
        'campaigns' => false
    ];
    ...
    {
        $this->setIfExists('applicationCartItemFilterId', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($applicationCartItemFilterId)) {
            throw new \InvalidArgumentException('non-nullable applicationCartItemFilterId cannot be null');
        }
