...
/**
 * ExpiringCardPointsNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExpiringCardPointsNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpiringCardPointsNotification';
    ...
    protected static $openAPITypes = [
        'totalResultSize' => 'int',
        'data' => '\TalonOne\Client\Model\ExpiringCardPointsData[]',
    ...
    public const NOTIFICATION_TYPE_LOYALTY_CARD_POINTS_EXPIRING = 'LoyaltyCardPointsExpiring';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_LOYALTY_CARD_POINTS_EXPIRING,
        ];
    }
    ...
    */
     ...
     * Gets data
     *
     * @return \TalonOne\Client\Model\ExpiringCardPointsData[]
     */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\ExpiringCardPointsData[] $data The array of expiring points.
     *
     * @return self
     */
