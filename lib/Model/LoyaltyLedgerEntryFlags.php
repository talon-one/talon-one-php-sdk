 ...
 */
class LoyaltyLedgerEntryFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('createsNegativeBalance', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($createsNegativeBalance)) {
            throw new \InvalidArgumentException('non-nullable createsNegativeBalance cannot be null');
        }
