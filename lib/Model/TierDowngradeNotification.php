...
/**
 * TierDowngradeNotification Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class TierDowngradeNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TierDowngradeNotification';
    ...
    protected static $openAPITypes = [
        'totalResultSize' => 'int',
        'data' => '\TalonOne\Client\Model\TierDowngradeData[]',
    ...
    public const NOTIFICATION_TYPE_TIER_DOWNGRADE = 'TierDowngrade';
    ...
    {
        return [
            self::NOTIFICATION_TYPE_TIER_DOWNGRADE,
        ];
    }
    ...
    */
     ...
     * Gets data
     *
     * @return \TalonOne\Client\Model\TierDowngradeData[]
     */
     ...
     * Sets data
     *
     * @param \TalonOne\Client\Model\TierDowngradeData[] $data The array of tier downgrade notifications.
     *
     * @return self
     */
