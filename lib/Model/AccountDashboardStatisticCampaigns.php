 ...
 */
class AccountDashboardStatisticCampaigns implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('endingSoon', $data ?? [], null);
        $this->setIfExists('lowOnBudget', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($endingSoon)) {
            throw new \InvalidArgumentException('non-nullable endingSoon cannot be null');
        }
    ...
    {
        if (is_null($lowOnBudget)) {
            throw new \InvalidArgumentException('non-nullable lowOnBudget cannot be null');
        }
