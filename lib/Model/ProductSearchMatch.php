...
/**
 * ProductSearchMatch Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductSearchMatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductSearchMatch';
    ...
    */
     ...
     * Sets value
     *
     * @param string $value The string matching the given value. Either a product name or SKU.
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setProductSkuId($productSkuId)
    {
        if (is_null($productSkuId)) {
            throw new \InvalidArgumentException('non-nullable productSkuId cannot be null');
        }
