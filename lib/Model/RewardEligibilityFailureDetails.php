...
/**
 * RewardEligibilityFailureDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class RewardEligibilityFailureDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RewardEligibilityFailureDetails';
     ...
     * Sets failureCode
     *
     * @param string $failureCode A code identifying why the customer is not eligible for the reward.
     *
     * @return self
     */
