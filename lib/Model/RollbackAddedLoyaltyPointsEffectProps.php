 ...
 */
class RollbackAddedLoyaltyPointsEffectProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets programId
     *
     * @param int $programId The ID of the loyalty program where these points were rolled back.
     *
     * @return self
     */
     ...
     * Sets subLedgerId
     *
     * @param string $subLedgerId The ID of the subledger within the loyalty program where these points were rolled back.
     *
     * @return self
     */
     ...
     *
     * @param string $recipientIntegrationId The user for whom these points were rolled back.
     *
     * @return self
     */
     ...
     *
     * @param float|null $cartItemPosition (_Add points per cart item_ only.) The index of the item in the `cartItem` object for which these points were rolled back.
     *
     * @return self
     */
     ...
     * Sets cardIdentifier
     *
     * @param string|null $cardIdentifier The identifier of the card on which these points were originally added.
     *
     * @return self
     */
