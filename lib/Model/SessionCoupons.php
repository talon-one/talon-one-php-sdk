...
/**
 * SessionCoupons Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class SessionCoupons implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SessionCoupons';
    ...
    */
     ...
     *
     * @param string $sessionIntegrationId The integration ID of the session in which the coupons were applied.
     *
     * @return self
     */
     ...
     * Sets couponCode
     *
     * @param string|null $couponCode The coupon codes for which rejection reason is needed.
     *
     * @return self
     */
