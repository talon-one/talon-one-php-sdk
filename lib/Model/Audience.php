...
class Audience implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('createdIn3rdParty', $data ?? [], null);
    ...
    {
        if (is_null($createdIn3rdParty)) {
            throw new \InvalidArgumentException('non-nullable createdIn3rdParty cannot be null');
        }
