...
/**
 * CampaignNotificationPolicy Class Doc Comment
 *
 * @category Class
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignNotificationPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignNotificationPolicy';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('batchSize', $data ?? [], 5);
    }
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CampaignNotificationPolicy., must be bigger than or equal to 1.');
        }
